...
object types:
  ...
  opaque type sg_shader_desc = CStruct6[uint32_t, CArray[sg_shader_attr_desc, Nat.Digit2[Nat._1, Nat._6]], sg_shader_stage_desc, sg_shader_stage_desc, Ptr[CUnsignedChar], uint32_t]
  object sg_shader_desc:
    given _tag: Tag[sg_shader_desc] = Tag.materializeCStruct6Tag[uint32_t, CArray[sg_shader_attr_desc, Nat.Digit2[Nat._1, Nat._6]], sg_shader_stage_desc, sg_shader_stage_desc, Ptr[CUnsignedChar], uint32_t]
    extension (struct: sg_shader_desc)
      ...
      def label: Ptr[CUnsignedChar] = struct._5
  ...
  opaque type sg_pass_desc = CStruct5[uint32_t, CArray[sg_pass_attachment_desc, Nat._4], sg_pass_attachment_desc, Ptr[CUnsignedChar], uint32_t]
  object sg_pass_desc:
    given _tag: Tag[sg_pass_desc] = Tag.materializeCStruct5Tag[uint32_t, CArray[sg_pass_attachment_desc, Nat._4], sg_pass_attachment_desc, Ptr[CUnsignedChar], uint32_t]
  ...
  opaque type sg_shader_image_desc = CStruct3[Ptr[CUnsignedChar], sg_image_type, sg_sampler_type]
  object sg_shader_image_desc:
    given _tag: Tag[sg_shader_image_desc] = Tag.materializeCStruct3Tag[Ptr[CUnsignedChar], sg_image_type, sg_sampler_type]
  ...
  opaque type sg_shader_stage_desc = CStruct6[Ptr[CUnsignedChar], sg_range, Ptr[CUnsignedChar], Ptr[CUnsignedChar], CArray[sg_shader_uniform_block_desc, Nat._4], CArray[sg_shader_image_desc, Nat.Digit2[Nat._1, Nat._2]]]
  object sg_shader_stage_desc:
    given _tag: Tag[sg_shader_stage_desc] = Tag.materializeCStruct6Tag[Ptr[CUnsignedChar], sg_range, Ptr[CUnsignedChar], Ptr[CUnsignedChar], CArray[sg_shader_uniform_block_desc, Nat._4], CArray[sg_shader_image_desc, Nat.Digit2[Nat._1, Nat._2]]]
    extension (struct: sg_shader_stage_desc)
      def source: Ptr[CUnsignedChar] = struct._1
      def bytecode: sg_range = struct._2
      def entry: Ptr[CUnsignedChar] = struct._3
      def d3d11_target: Ptr[CUnsignedChar] = struct._4
  ...
  opaque type sg_shader_attr_desc = CStruct3[Ptr[CUnsignedChar], Ptr[CUnsignedChar], CInt]
  object sg_shader_attr_desc:
    given _tag: Tag[sg_shader_attr_desc] = Tag.materializeCStruct3Tag[Ptr[CUnsignedChar], Ptr[CUnsignedChar], CInt]
    extension (struct: sg_shader_attr_desc)
      def name: Ptr[CUnsignedChar] = struct._1
      def sem_name: Ptr[CUnsignedChar] = struct._2
  ...
  object sg_trace_hooks:
    ...
    extension (struct: sg_trace_hooks)
      ...
      def push_debug_group: Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[Byte], Unit]] = !struct.at(400).asInstanceOf[Ptr[Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[Byte], Unit]]]]
  ...
  opaque type sg_buffer_desc = CStruct11[uint32_t, size_t, sg_buffer_type, sg_usage, sg_range, Ptr[CUnsignedChar], CArray[uint32_t, Nat._2], CArray[Ptr[Byte], Nat._2], Ptr[Byte], Ptr[Byte], uint32_t]
  object sg_buffer_desc:
    given _tag: Tag[sg_buffer_desc] = Tag.materializeCStruct11Tag[uint32_t, size_t, sg_buffer_type, sg_usage, sg_range, Ptr[CUnsignedChar], CArray[uint32_t, Nat._2], CArray[Ptr[Byte], Nat._2], Ptr[Byte], Ptr[Byte], uint32_t]
    extension (struct: sg_buffer_desc)
      ...
      def label: Ptr[CUnsignedChar] = struct._6
  ...
  object sg_image_desc:
    ...
    extension (struct: sg_image_desc)
      ...
      def label: Ptr[CUnsignedChar] = !struct.at(1616).asInstanceOf[Ptr[Ptr[CUnsignedChar]]]
  ...
  opaque type sg_shader_uniform_desc = CStruct3[Ptr[CUnsignedChar], sg_uniform_type, CInt]
  object sg_shader_uniform_desc:
    given _tag: Tag[sg_shader_uniform_desc] = Tag.materializeCStruct3Tag[Ptr[CUnsignedChar], sg_uniform_type, CInt]
    extension (struct: sg_shader_uniform_desc)
      def name: Ptr[CUnsignedChar] = struct._1
      def `type`: sg_uniform_type = struct._2
      def array_count: CInt = struct._3

  opaque type sg_pipeline_desc = CStruct16[uint32_t, sg_shader, sg_layout_desc, sg_depth_state, sg_stencil_state, CInt, CArray[sg_color_state, Nat._4], sg_primitive_type, sg_index_type, sg_cull_mode, sg_face_winding, CInt, sg_color, CInt, Ptr[CUnsignedChar], uint32_t]
  object sg_pipeline_desc:
    given _tag: Tag[sg_pipeline_desc] = Tag.materializeCStruct16Tag[uint32_t, sg_shader, sg_layout_desc, sg_depth_state, sg_stencil_state, CInt, CArray[sg_color_state, Nat._4], sg_primitive_type, sg_index_type, sg_cull_mode, sg_face_winding, CInt, sg_color, CInt, Ptr[CUnsignedChar], uint32_t]
    extension (struct: sg_pipeline_desc)
      ...
      def label: Ptr[CUnsignedChar] = struct._15
...
object functions: 
  ...
  def sg_push_debug_group(name: Ptr[CUnsignedChar]): Unit = extern
