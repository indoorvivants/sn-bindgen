...
object types:
  ...
  opaque type LoadFileDataCallback = CFuncPtr2[CString, Ptr[CUnsignedInt], Ptr[CUnsignedChar]]
  object LoadFileDataCallback: 
    given _tag: Tag[LoadFileDataCallback] = Tag.materializeCFuncPtr2[CString, Ptr[CUnsignedInt], Ptr[CUnsignedChar]]
    inline def apply(inline o: CFuncPtr2[CString, Ptr[CUnsignedInt], Ptr[CUnsignedChar]]): LoadFileDataCallback = o
  ...
  opaque type SaveFileDataCallback = CFuncPtr3[CString, Ptr[Byte], CUnsignedInt, Boolean]
  object SaveFileDataCallback: 
    given _tag: Tag[SaveFileDataCallback] = Tag.materializeCFuncPtr3[CString, Ptr[Byte], CUnsignedInt, Boolean]
    inline def apply(inline o: CFuncPtr3[CString, Ptr[Byte], CUnsignedInt, Boolean]): SaveFileDataCallback = o
