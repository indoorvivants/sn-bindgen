...
object types:
  ...
  opaque type LoadFileDataCallback = Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedInt], Ptr[CUnsignedChar]]]
  object LoadFileDataCallback: 
    given _tag: Tag[LoadFileDataCallback] = Tag.Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedInt], Ptr[CUnsignedChar]]](Tag.materializeCFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedInt], Ptr[CUnsignedChar]])
    inline def apply(inline o: Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedInt], Ptr[CUnsignedChar]]]): LoadFileDataCallback = o

  type TextureCubemap = Texture
  object TextureCubemap: 
    given _tag: Tag[TextureCubemap] = Texture._tag
  opaque type SaveFileTextCallback = Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedChar], CInt]]
  object SaveFileTextCallback: 
    given _tag: Tag[SaveFileTextCallback] = Tag.Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedChar], CInt]](Tag.materializeCFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedChar], CInt])
    inline def apply(inline o: Ptr[CFuncPtr2[Ptr[CUnsignedChar], Ptr[CUnsignedChar], CInt]]): SaveFileTextCallback = o

  type Camera = Camera3D
  object Camera: 
    given _tag: Tag[Camera] = Camera3D._tag

  opaque type TraceLogCallback = Ptr[CFuncPtr3[CInt, Ptr[CUnsignedChar], CInt, Unit]]
  object TraceLogCallback: 
    given _tag: Tag[TraceLogCallback] = Tag.Ptr[CFuncPtr3[CInt, Ptr[CUnsignedChar], CInt, Unit]](Tag.materializeCFuncPtr3[CInt, Ptr[CUnsignedChar], CInt, Unit])
    inline def apply(inline o: Ptr[CFuncPtr3[CInt, Ptr[CUnsignedChar], CInt, Unit]]): TraceLogCallback = o
  ...
  opaque type LoadFileTextCallback = Ptr[CFuncPtr1[Ptr[CUnsignedChar], Ptr[CUnsignedChar]]]
  object LoadFileTextCallback: 
    given _tag: Tag[LoadFileTextCallback] = Tag.Ptr[CFuncPtr1[Ptr[CUnsignedChar], Ptr[CUnsignedChar]]](Tag.materializeCFuncPtr1[Ptr[CUnsignedChar], Ptr[CUnsignedChar]])
    inline def apply(inline o: Ptr[CFuncPtr1[Ptr[CUnsignedChar], Ptr[CUnsignedChar]]]): LoadFileTextCallback = o
  ...
  opaque type BoneInfo = CStruct2[CArray[CUnsignedChar, Nat.Digit2[Nat._3, Nat._2]], CInt]
  object BoneInfo:
    given _tag: Tag[BoneInfo] = Tag.materializeCStruct2Tag[CArray[CUnsignedChar, Nat.Digit2[Nat._3, Nat._2]], CInt]
    extension (struct: BoneInfo)
      def name: CArray[CUnsignedChar, Nat.Digit2[Nat._3, Nat._2]] = struct._1
...
object functions: 
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadWaveFromMemory(fileType: Ptr[CUnsignedChar], fileData: Ptr[CUnsignedChar], dataSize: CInt): Wave = extern
  ...
  def EncodeDataBase64(data: Ptr[CUnsignedChar], dataLength: CInt, outputLength: Ptr[CInt]): Ptr[CUnsignedChar] = extern
  ...
  def TextFormat(text: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern

  def LoadModelAnimations(fileName: Ptr[CUnsignedChar], animCount: Ptr[CUnsignedInt]): Ptr[ModelAnimation] = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadTextureCubemap(image: Image, layout: CInt): TextureCubemap = extern

  def GetFileNameWithoutExt(filePath: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadImage(fileName: Ptr[CUnsignedChar]): Image = extern
  ...
  def TextSubtext(text: Ptr[CUnsignedChar], position: CInt, length: CInt): Ptr[CUnsignedChar] = extern

  def WaitTime(ms: Float): Unit = extern

  def CodepointToUTF8(codepoint: CInt, byteSize: Ptr[CInt]): Ptr[CUnsignedChar] = extern

  def IsWindowHidden(): CInt = extern

  def ClearDroppedFiles(): Unit = extern

  def GetFileModTime(fileName: Ptr[CUnsignedChar]): CLongInt = extern
  ...
  def TextLength(text: Ptr[CUnsignedChar]): CUnsignedInt = extern

  def GetGamepadButtonPressed(): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadImageAnim(fileName: Ptr[CUnsignedChar], frames: Ptr[CInt]): Image = extern
  ...
  def GetMonitorName(monitor: CInt): Ptr[CUnsignedChar] = extern
  ...
  def TraceLog(logLevel: CInt, text: Ptr[CUnsignedChar]): Unit = extern
  ...
  def TextToLower(text: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  def GetCodepoint(text: Ptr[CUnsignedChar], bytesProcessed: Ptr[CInt]): CInt = extern
  ...
  def GetGamepadName(gamepad: CInt): Ptr[CUnsignedChar] = extern

  def SetWindowPosition(x: CInt, y: CInt): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def ImageDrawText(dst: Ptr[Image], text: Ptr[CUnsignedChar], posX: CInt, posY: CInt, fontSize: CInt, color: Color): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def ImageTextEx(font: Font, text: Ptr[CUnsignedChar], fontSize: Float, spacing: Float, tint: Color): Image = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def GetCollisionRec(rec1: Rectangle, rec2: Rectangle): Rectangle = extern

  def GetFileName(filePath: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern

  def CheckCollisionSpheres(): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def DrawTextEx(font: Font, text: Ptr[CUnsignedChar], position: Vector2, fontSize: Float, spacing: Float, tint: Color): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadSound(fileName: Ptr[CUnsignedChar]): Sound = extern
  ...
  def UnloadFileText(text: Ptr[CUnsignedChar]): Unit = extern
  ...
  def TextFindIndex(text: Ptr[CUnsignedChar], find: Ptr[CUnsignedChar]): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def GetShaderLocation(shader: Shader, uniformName: Ptr[CUnsignedChar]): CInt = extern

  def LoadFileData(fileName: Ptr[CUnsignedChar], bytesRead: Ptr[CUnsignedInt]): Ptr[CUnsignedChar] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadFontFromMemory(fileType: Ptr[CUnsignedChar], fileData: Ptr[CUnsignedChar], dataSize: CInt, fontSize: CInt, fontChars: Ptr[CInt], glyphCount: CInt): Font = extern
  ...
  def InitWindow(width: CInt, height: CInt, title: Ptr[CUnsignedChar]): Unit = extern

  def LoadCodepoints(text: Ptr[CUnsignedChar], count: Ptr[CInt]): Ptr[CInt] = extern
  ...
  def TextCodepointsToUTF8(codepoints: Ptr[CInt], length: CInt): Ptr[CUnsignedChar] = extern
  ...
  def GetPrevDirectoryPath(dirPath: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern

  def TextAppend(text: Ptr[CUnsignedChar], append: Ptr[CUnsignedChar], position: Ptr[CInt]): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def StopSound(sound: Sound): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def ImageDrawTextEx(dst: Ptr[Image], font: Font, text: Ptr[CUnsignedChar], position: Vector2, fontSize: Float, spacing: Float, tint: Color): Unit = extern
  ...
  def GetDroppedFiles(count: Ptr[CInt]): Ptr[Ptr[CUnsignedChar]] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadModel(fileName: Ptr[CUnsignedChar]): Model = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def ImageText(text: Ptr[CUnsignedChar], fontSize: CInt, color: Color): Image = extern
  ...
  def TakeScreenshot(fileName: Ptr[CUnsignedChar]): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadShader(vsFileName: Ptr[CUnsignedChar], fsFileName: Ptr[CUnsignedChar]): Shader = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadFont(fileName: Ptr[CUnsignedChar]): Font = extern
  ...
  def TextToInteger(text: Ptr[CUnsignedChar]): CInt = extern

  def GetCodepointCount(text: Ptr[CUnsignedChar]): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def DrawTextPro(font: Font, text: Ptr[CUnsignedChar], position: Vector2, origin: Vector2, rotation: Float, fontSize: Float, spacing: Float, tint: Color): Unit = extern
  ...
  def TextJoin(textList: Ptr[Ptr[CUnsignedChar]], count: CInt, delimiter: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  def SetGamepadMappings(mappings: Ptr[CUnsignedChar]): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def GetShaderLocationAttrib(shader: Shader, attribName: Ptr[CUnsignedChar]): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadImageRaw(fileName: Ptr[CUnsignedChar], width: CInt, height: CInt, format: CInt, headerSize: CInt): Image = extern
  ...
  def TextToUpper(text: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern

  def CheckCollisionPointTriangle(): CInt = extern

  def LoadFileText(fileName: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadWave(fileName: Ptr[CUnsignedChar]): Wave = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def PlayMusicStream(music: Music): Unit = extern

  def SetClipboardText(text: Ptr[CUnsignedChar]): Unit = extern
  ...
  def GetFileExtension(fileName: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  def TextSplit(text: Ptr[CUnsignedChar], delimiter: CUnsignedChar, count: Ptr[CInt]): Ptr[Ptr[CUnsignedChar]] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadImageFromMemory(fileType: Ptr[CUnsignedChar], fileData: Ptr[CUnsignedChar], dataSize: CInt): Image = extern

  def TextToPascal(text: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadMusicStreamFromMemory(fileType: Ptr[CUnsignedChar], data: Ptr[CUnsignedChar], dataSize: CInt): Music = extern

  def GetWorkingDirectory(): Ptr[CUnsignedChar] = extern
  ...
  def OpenURL(url: Ptr[CUnsignedChar]): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def MeasureTextEx(font: Font, text: Ptr[CUnsignedChar], fontSize: Float, spacing: Float): Vector2 = extern
  ...
  def LoadMaterials(fileName: Ptr[CUnsignedChar], materialCount: Ptr[CInt]): Ptr[Material] = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def DrawText(text: Ptr[CUnsignedChar], posX: CInt, posY: CInt, fontSize: CInt, color: Color): Unit = extern
  ...
  def GetDirectoryPath(filePath: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  def TextCopy(dst: Ptr[CUnsignedChar], src: Ptr[CUnsignedChar]): CInt = extern

  def SetMouseOffset(offsetX: CInt, offsetY: CInt): Unit = extern

  def UnloadImageColors(colors: Ptr[Color]): Unit = extern

  def TextReplace(text: Ptr[CUnsignedChar], replace: Ptr[CUnsignedChar], by: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern

  def SetWindowTitle(title: Ptr[CUnsignedChar]): Unit = extern

  def GetDirectoryFiles(dirPath: Ptr[CUnsignedChar], count: Ptr[CInt]): Ptr[Ptr[CUnsignedChar]] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadFontEx(fileName: Ptr[CUnsignedChar], fontSize: CInt, fontChars: Ptr[CInt], glyphCount: CInt): Font = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadTexture(fileName: Ptr[CUnsignedChar]): Texture2D = extern
  ...
  def TextInsert(text: Ptr[CUnsignedChar], insert: Ptr[CUnsignedChar], position: CInt): Ptr[CUnsignedChar] = extern
  ...
  def MeasureText(text: Ptr[CUnsignedChar], fontSize: CInt): CInt = extern
  ...
  def GetClipboardText(): Ptr[CUnsignedChar] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadMusicStream(fileName: Ptr[CUnsignedChar]): Music = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def LoadShaderFromMemory(vsCode: Ptr[CUnsignedChar], fsCode: Ptr[CUnsignedChar]): Shader = extern
