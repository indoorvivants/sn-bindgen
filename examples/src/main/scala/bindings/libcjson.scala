Function(cJSON_Version,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),const char *))
Function(cJSON_InitHooks,Void,ListBuffer(),Extern,OriginalCType(Void,void))
Function(cJSON_Parse,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_ParseWithLength,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_ParseWithOpts,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_ParseWithLengthOpts,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_Print,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),char *))
Function(cJSON_PrintUnformatted,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),char *))
Function(cJSON_PrintBuffered,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),char *))
Function(cJSON_PrintPreallocated,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_Delete,Void,ListBuffer(),Extern,OriginalCType(Void,void))
Function(cJSON_GetArraySize,NumericIntegral(Int,Signed),ListBuffer(),Extern,OriginalCType(NumericIntegral(Int,Signed),int))
Function(cJSON_GetArrayItem,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_GetObjectItem,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_GetObjectItemCaseSensitive,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_HasObjectItem,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_GetErrorPtr,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),const char *))
Function(cJSON_GetStringValue,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),char *))
Function(cJSON_GetNumberValue,NumericReal(Double),ListBuffer(),Extern,OriginalCType(NumericReal(Double),double))
Function(cJSON_IsInvalid,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsFalse,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsTrue,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsBool,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsNull,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsNumber,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsString,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsArray,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsObject,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_IsRaw,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_CreateNull,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateTrue,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateFalse,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateBool,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateNumber,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateString,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateRaw,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateArray,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateStringReference,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateObjectReference,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateArrayReference,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateIntArray,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateFloatArray,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateDoubleArray,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_CreateStringArray,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddItemToArray,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_AddItemToObject,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_AddItemToObjectCS,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_AddItemReferenceToArray,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_AddItemReferenceToObject,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_DetachItemViaPointer,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_DetachItemFromArray,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_DeleteItemFromArray,Void,ListBuffer(),Extern,OriginalCType(Void,void))
Function(cJSON_DetachItemFromObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_DetachItemFromObjectCaseSensitive,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_DeleteItemFromObject,Void,ListBuffer(),Extern,OriginalCType(Void,void))
Function(cJSON_DeleteItemFromObjectCaseSensitive,Void,ListBuffer(),Extern,OriginalCType(Void,void))
Function(cJSON_InsertItemInArray,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_ReplaceItemViaPointer,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_ReplaceItemInArray,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_ReplaceItemInObject,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_ReplaceItemInObjectCaseSensitive,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_Duplicate,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_Compare,Typedef(cJSON_bool),ListBuffer(),Extern,OriginalCType(Typedef(cJSON_bool),cJSON_bool))
Function(cJSON_Minify,Void,ListBuffer(),Extern,OriginalCType(Void,void))
Function(cJSON_AddNullToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddTrueToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddFalseToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddBoolToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddNumberToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddStringToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddRawToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddObjectToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_AddArrayToObject,Pointer(Typedef(cJSON)),ListBuffer(),Extern,OriginalCType(Pointer(Typedef(cJSON)),cJSON *))
Function(cJSON_SetNumberHelper,NumericReal(Double),ListBuffer(),Extern,OriginalCType(NumericReal(Double),double))
Function(cJSON_SetValuestring,Pointer(NumericIntegral(Char,Signed)),ListBuffer(),Extern,OriginalCType(Pointer(NumericIntegral(Char,Signed)),char *))
Function(cJSON_malloc,Pointer(Void),ListBuffer(),Extern,OriginalCType(Pointer(Void),void *))
Function(cJSON_free,Void,ListBuffer(),Extern,OriginalCType(Void,void))
package libcjson
