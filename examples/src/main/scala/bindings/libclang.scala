...
object types:
  ...
  opaque type tm = CStruct11[CInt, CInt, CInt, CInt, CInt, CInt, CInt, CInt, CInt, CLongInt, Ptr[CUnsignedChar]]
  object tm:
    given _tag: Tag[tm] = Tag.materializeCStruct11Tag[CInt, CInt, CInt, CInt, CInt, CInt, CInt, CInt, CInt, CLongInt, Ptr[CUnsignedChar]]
    extension (struct: tm)
      ...
      def tm_zone: Ptr[CUnsignedChar] = struct._11
...
object functions: 
  ...
  def ctime(_0: Ptr[time_t]): Ptr[CUnsignedChar] = extern
  ...
  def ctime_r(_0: Ptr[time_t], _1: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  def getdate(_0: Ptr[CUnsignedChar]): Ptr[tm] = extern
  ...
  def strftime(_0: Ptr[CUnsignedChar], _1: size_t, _2: Ptr[CUnsignedChar], _3: Ptr[tm]): size_t = extern
  ...
  def strptime(_0: Ptr[CUnsignedChar], _1: Ptr[CUnsignedChar], _2: Ptr[tm]): Ptr[CUnsignedChar] = extern
  ...
  def asctime_r(_0: Ptr[tm], _1: Ptr[CUnsignedChar]): Ptr[CUnsignedChar] = extern
  ...
  def asctime(_0: Ptr[tm]): Ptr[CUnsignedChar] = extern
