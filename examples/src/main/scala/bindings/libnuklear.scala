...
object types:
  ...
  opaque type nk_context = CStruct20[nk_input, nk_style, nk_buffer, nk_clipboard, nk_flags, nk_button_behavior, nk_configuration_stacks, Float, nk_text_edit, nk_command_buffer, CInt, CInt, nk_pool, Ptr[nk_window], Ptr[nk_window], Ptr[nk_window], Ptr[nk_window], Ptr[nk_page_element], CUnsignedInt, CUnsignedInt]
  object nk_context:
    given _tag: Tag[nk_context] = Tag.materializeCStruct20Tag[nk_input, nk_style, nk_buffer, nk_clipboard, nk_flags, nk_button_behavior, nk_configuration_stacks, Float, nk_text_edit, nk_command_buffer, CInt, CInt, nk_pool, Ptr[nk_window], Ptr[nk_window], Ptr[nk_window], Ptr[nk_window], Ptr[nk_page_element], CUnsignedInt, CUnsignedInt]
    ...
    extension (struct: nk_context)
      ...
      def begin: Ptr[nk_window] = struct._14
      def begin_=(value: Ptr[nk_window]): Unit = !struct.at14 = value
      def end: Ptr[nk_window] = struct._15
      def end_=(value: Ptr[nk_window]): Unit = !struct.at15 = value
      def active: Ptr[nk_window] = struct._16
      def active_=(value: Ptr[nk_window]): Unit = !struct.at16 = value
      def current: Ptr[nk_window] = struct._17
      def current_=(value: Ptr[nk_window]): Unit = !struct.at17 = value
      def freelist: Ptr[nk_page_element] = struct._18
      def freelist_=(value: Ptr[nk_page_element]): Unit = !struct.at18 = value
  ...
  opaque type nk_style_button = CStruct17[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_color, nk_color, nk_color, nk_color, nk_flags, Float, Float, nk_vec2, nk_vec2, nk_vec2, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
  object nk_style_button:
    given _tag: Tag[nk_style_button] = Tag.materializeCStruct17Tag[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_color, nk_color, nk_color, nk_color, nk_flags, Float, Float, nk_vec2, nk_vec2, nk_vec2, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
    def apply()(using Zone): Ptr[nk_style_button] = scala.scalanative.unsafe.alloc[nk_style_button](1)
    def apply(normal: nk_style_item, hover: nk_style_item, active: nk_style_item, border_color: nk_color, text_background: nk_color, text_normal: nk_color, text_hover: nk_color, text_active: nk_color, text_alignment: nk_flags, border: Float, rounding: Float, padding: nk_vec2, image_padding: nk_vec2, touch_padding: nk_vec2, userdata: nk_handle, draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]])(using Zone): Ptr[nk_style_button] = 
      val ____ptr = apply()
    ...
    extension (struct: nk_style_button)
      ...
      def draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._16
      def draw_begin_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at16 = value
      def draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._17
      def draw_end_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at17 = value
  ...
  opaque type nk_style_progress = CStruct16[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_style_item, nk_style_item, nk_style_item, nk_color, Float, Float, Float, Float, nk_vec2, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
  object nk_style_progress:
    given _tag: Tag[nk_style_progress] = Tag.materializeCStruct16Tag[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_style_item, nk_style_item, nk_style_item, nk_color, Float, Float, Float, Float, nk_vec2, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
    def apply()(using Zone): Ptr[nk_style_progress] = scala.scalanative.unsafe.alloc[nk_style_progress](1)
    def apply(normal: nk_style_item, hover: nk_style_item, active: nk_style_item, border_color: nk_color, cursor_normal: nk_style_item, cursor_hover: nk_style_item, cursor_active: nk_style_item, cursor_border_color: nk_color, rounding: Float, border: Float, cursor_border: Float, cursor_rounding: Float, padding: nk_vec2, userdata: nk_handle, draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]])(using Zone): Ptr[nk_style_progress] = 
      val ____ptr = apply()
      (!____ptr).normal = normal
      (!____ptr).hover = hover
      (!____ptr).active = active
    ...
    extension (struct: nk_style_progress)
      ...
      def draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._15
      def draw_begin_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at15 = value
      def draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._16
      def draw_end_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at16 = value

  opaque type nk_style_property = CStruct18[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_color, nk_color, nk_color, nk_symbol_type, nk_symbol_type, Float, Float, nk_vec2, nk_style_edit, nk_style_button, nk_style_button, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
  object nk_style_property:
    ...
    extension (struct: nk_style_property)
      ...
      def draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._17
      def draw_begin_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at17 = value
      def draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._18
      def draw_end_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at18 = value

  opaque type nk_style_scrollbar = CStruct21[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_style_item, nk_style_item, nk_style_item, nk_color, Float, Float, Float, Float, nk_vec2, CInt, nk_style_button, nk_style_button, nk_symbol_type, nk_symbol_type, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
  object nk_style_scrollbar:
    ...
    def apply(normal: nk_style_item, hover: nk_style_item, active: nk_style_item, border_color: nk_color, cursor_normal: nk_style_item, cursor_hover: nk_style_item, cursor_active: nk_style_item, cursor_border_color: nk_color, border: Float, rounding: Float, border_cursor: Float, rounding_cursor: Float, padding: nk_vec2, show_buttons: CInt, inc_button: nk_style_button, dec_button: nk_style_button, inc_symbol: nk_symbol_type, dec_symbol: nk_symbol_type, userdata: nk_handle, draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]])(using Zone): Ptr[nk_style_scrollbar] = 
      val ____ptr = apply()
      (!____ptr).normal = normal
      (!____ptr).hover = hover
      (!____ptr).active = active
    ...
    extension (struct: nk_style_scrollbar)
      ...
      def draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._20
      def draw_begin_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at20 = value
      def draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = struct._21
      def draw_end_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at21 = value

  opaque type nk_style_selectable = CStruct21[nk_style_item, nk_style_item, nk_style_item, nk_style_item, nk_style_item, nk_style_item, nk_color, nk_color, nk_color, nk_color, nk_color, nk_color, nk_color, nk_flags, Float, nk_vec2, nk_vec2, nk_vec2, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
  object nk_style_selectable:
    given _tag: Tag[nk_style_selectable] = Tag.materializeCStruct21Tag[nk_style_item, nk_style_item, nk_style_item, nk_style_item, nk_style_item, nk_style_item, nk_color, nk_color, nk_color, nk_color, nk_color, nk_color, nk_color, nk_flags, Float, nk_vec2, nk_vec2, nk_vec2, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
    def apply()(using Zone): Ptr[nk_style_selectable] = scala.scalanative.unsafe.alloc[nk_style_selectable](1)
    def apply(normal: nk_style_item, hover: nk_style_item, pressed: nk_style_item, normal_active: nk_style_item, hover_active: nk_style_item, pressed_active: nk_style_item, text_normal: nk_color, text_hover: nk_color, text_pressed: nk_color, text_normal_active: nk_color, text_hover_active: nk_color, text_pressed_active: nk_color, text_background: nk_color, text_alignment: nk_flags, rounding: Float, padding: nk_vec2, touch_padding: nk_vec2, image_padding: nk_vec2, userdata: nk_handle, draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]])(using Zone): Ptr[nk_style_selectable] = 
      val ____ptr = apply()
      (!____ptr).normal = normal
      (!____ptr).hover = hover
  ...
  object nk_style_slider:
    ...
    extension (struct: nk_style_slider)
      ...
      def draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = !struct.at(624).asInstanceOf[Ptr[Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]]
      def draw_begin_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at(624).asInstanceOf[Ptr[Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]] = value
      def draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]] = !struct.at(632).asInstanceOf[Ptr[Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]]
      def draw_end_=(value: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]): Unit = !struct.at(632).asInstanceOf[Ptr[Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]] = value
  ...
  opaque type nk_style_toggle = CStruct18[nk_style_item, nk_style_item, nk_style_item, nk_color, nk_style_item, nk_style_item, nk_color, nk_color, nk_color, nk_color, nk_flags, nk_vec2, nk_vec2, Float, Float, nk_handle, Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]]]
  object nk_style_toggle:
    ...
    def apply(normal: nk_style_item, hover: nk_style_item, active: nk_style_item, border_color: nk_color, cursor_normal: nk_style_item, cursor_hover: nk_style_item, text_normal: nk_color, text_hover: nk_color, text_active: nk_color, text_background: nk_color, text_alignment: nk_flags, padding: nk_vec2, touch_padding: nk_vec2, spacing: Float, border: Float, userdata: nk_handle, draw_begin: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]], draw_end: Ptr[CFuncPtr2[Ptr[nk_command_buffer], nk_handle, Unit]])(using Zone): Ptr[nk_style_toggle] = 
      val ____ptr = apply()
      (!____ptr).normal = normal
      (!____ptr).hover = hover
      (!____ptr).active = active
  ...
  opaque type nk_text_edit = CStruct16[nk_clipboard, nk_str, nk_plugin_filter, nk_vec2, CInt, CInt, CInt, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, Float, nk_text_undo_state]
  object nk_text_edit:
    given _tag: Tag[nk_text_edit] = Tag.materializeCStruct16Tag[nk_clipboard, nk_str, nk_plugin_filter, nk_vec2, CInt, CInt, CInt, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, CUnsignedChar, Float, nk_text_undo_state]
    ...
    extension (struct: nk_text_edit)
      ...
      def filter: nk_plugin_filter = struct._3
      def filter_=(value: nk_plugin_filter): Unit = !struct.at3 = value
  ...
  opaque type nk_window = CStruct18[CUnsignedInt, nk_hash, CArray[CChar, Nat.Digit2[Nat._6, Nat._4]], nk_flags, nk_rect, nk_scroll, nk_command_buffer, Ptr[nk_panel], Float, nk_property_state, nk_popup_state, nk_edit_state, CUnsignedInt, Ptr[nk_table], CUnsignedInt, Ptr[Byte], Ptr[Byte], Ptr[Byte]]
  object nk_window:
    given _tag: Tag[nk_window] = Tag.materializeCStruct18Tag[CUnsignedInt, nk_hash, CArray[CChar, Nat.Digit2[Nat._6, Nat._4]], nk_flags, nk_rect, nk_scroll, nk_command_buffer, Ptr[nk_panel], Float, nk_property_state, nk_popup_state, nk_edit_state, CUnsignedInt, Ptr[nk_table], CUnsignedInt, Ptr[Byte], Ptr[Byte], Ptr[Byte]]
    ...
    extension (struct: nk_window)
      ...
      def layout: Ptr[nk_panel] = struct._8
      def layout_=(value: Ptr[nk_panel]): Unit = !struct.at8 = value
      ...
      def tables: Ptr[nk_table] = struct._14
      def tables_=(value: Ptr[nk_table]): Unit = !struct.at14 = value
  ...
  opaque type stbrp_context = CStruct9[CInt, CInt, CInt, CInt, CInt, CInt, Ptr[stbrp_node], Ptr[stbrp_node], CArray[stbrp_node, Nat._2]]
  object stbrp_context:
    given _tag: Tag[stbrp_context] = Tag.materializeCStruct9Tag[CInt, CInt, CInt, CInt, CInt, CInt, Ptr[stbrp_node], Ptr[stbrp_node], CArray[stbrp_node, Nat._2]]
    ...
    extension (struct: stbrp_context)
      ...
      def active_head: Ptr[stbrp_node] = struct._7
      def active_head_=(value: Ptr[stbrp_node]): Unit = !struct.at7 = value
      def free_head: Ptr[stbrp_node] = struct._8
      def free_head_=(value: Ptr[stbrp_node]): Unit = !struct.at8 = value
...
private[libnuklear] object extern_functions: 
  ...
  private[libnuklear] def __sn_wrap_nk_combo_callback(ctx: Ptr[nk_context], item_getter: Ptr[CFuncPtr3[Ptr[Byte], CInt, Ptr[CString], Unit]], userdata: Ptr[Byte], selected: CInt, count: CInt, item_height: CInt, size: Ptr[nk_vec2]): CInt = extern
  ...
  private[libnuklear] def __sn_wrap_nk_combobox_callback(ctx: Ptr[nk_context], item_getter: Ptr[CFuncPtr3[Ptr[Byte], CInt, Ptr[CString], Unit]], userdata: Ptr[Byte], selected: Ptr[CInt], count: CInt, item_height: CInt, size: Ptr[nk_vec2]): Unit = extern
  ...
  private[libnuklear] def __sn_wrap_nk_hsv_bv(c: Ptr[nk_byte], __return: Ptr[nk_color]): Unit = extern
  ...
  private[libnuklear] def __sn_wrap_nk_rgb_fv(c: Ptr[Float], __return: Ptr[nk_color]): Unit = extern
  ...
  private[libnuklear] def __sn_wrap_nk_rgba_iv(c: Ptr[CInt], __return: Ptr[nk_color]): Unit = extern
  ...
  private[libnuklear] def __sn_wrap_nk_vec2iv(v: Ptr[CInt], __return: Ptr[nk_vec2]): Unit = extern

  @name("__sn_wrap_nk_vec2v")
  private[libnuklear] def __sn_wrap_nk_vec2v(v: Ptr[Float], __return: Ptr[nk_vec2]): Unit = extern
  ...
  def nk_memcopy(dst: Ptr[Byte], src: Ptr[Byte], n: nk_size): Ptr[Byte] = extern
  ...
  def nk_plot_function(ctx: Ptr[nk_context], `type`: nk_chart_type, userdata: Ptr[Byte], value_getter: Ptr[CFuncPtr2[Ptr[Byte], CInt, Float]], count: CInt, offset: CInt): Unit = extern
...
object functions: 
  ...
  def nk_combo_callback(ctx: Ptr[nk_context], item_getter: Ptr[CFuncPtr3[Ptr[Byte], CInt, Ptr[CString], Unit]], userdata: Ptr[Byte], selected: CInt, count: CInt, item_height: CInt, size: nk_vec2)(using Zone): CInt = 
  ...
  def nk_combobox_callback(ctx: Ptr[nk_context], item_getter: Ptr[CFuncPtr3[Ptr[Byte], CInt, Ptr[CString], Unit]], userdata: Ptr[Byte], selected: Ptr[CInt], count: CInt, item_height: CInt, size: nk_vec2)(using Zone): Unit = 
    val _ptr_6 = alloc[nk_vec2](1)
    !_ptr_6 = size
  ...
  def nk_rgba_iv(c: Ptr[CInt])(using Zone): nk_color = 
    val _ptr_return = alloc[nk_color](1)
    __sn_wrap_nk_rgba_iv(c, _ptr_return)
    !_ptr_return
  ...
  def nk_vec2iv(v: Ptr[CInt])(using Zone): nk_vec2 = 
    val _ptr_return = alloc[nk_vec2](1)
    __sn_wrap_nk_vec2iv(v, _ptr_return)
    !_ptr_return
