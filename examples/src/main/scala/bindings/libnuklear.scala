...
object types:
  ...
  opaque type nk_glyph = CArray[CUnsignedChar, Nat._4]
  object nk_glyph: 
    given _tag: Tag[nk_glyph] = Tag.CArray[CUnsignedChar, Nat._4](Tag.UByte, Tag.Nat4)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._4]): nk_glyph = o
  ...
  opaque type _dummy_array432 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array432: 
    given _tag: Tag[_dummy_array432] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array432 = o
  ...
  opaque type _dummy_array440 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array440: 
    given _tag: Tag[_dummy_array440] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array440 = o
  ...
  opaque type _dummy_array428 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array428: 
    given _tag: Tag[_dummy_array428] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array428 = o
  ...
  opaque type _dummy_array433 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array433: 
    given _tag: Tag[_dummy_array433] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array433 = o

  opaque type _dummy_array434 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array434: 
    given _tag: Tag[_dummy_array434] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array434 = o
  ...
  opaque type nk_plugin_copy = Ptr[CFuncPtr3[nk_handle, Ptr[CUnsignedChar], CInt, Unit]]
  object nk_plugin_copy: 
    given _tag: Tag[nk_plugin_copy] = Tag.Ptr[CFuncPtr3[nk_handle, Ptr[CUnsignedChar], CInt, Unit]](Tag.materializeCFuncPtr3[nk_handle, Ptr[CUnsignedChar], CInt, Unit])
    inline def apply(inline o: Ptr[CFuncPtr3[nk_handle, Ptr[CUnsignedChar], CInt, Unit]]): nk_plugin_copy = o
  ...
  opaque type _dummy_array431 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array431: 
    given _tag: Tag[_dummy_array431] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array431 = o

  opaque type _dummy_array430 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array430: 
    given _tag: Tag[_dummy_array430] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array430 = o
  ...
  opaque type nk_text_width_f = Ptr[CFuncPtr4[nk_handle, Float, Ptr[CUnsignedChar], CInt, Float]]
  object nk_text_width_f: 
    given _tag: Tag[nk_text_width_f] = Tag.Ptr[CFuncPtr4[nk_handle, Float, Ptr[CUnsignedChar], CInt, Float]](Tag.materializeCFuncPtr4[nk_handle, Float, Ptr[CUnsignedChar], CInt, Float])
    inline def apply(inline o: Ptr[CFuncPtr4[nk_handle, Float, Ptr[CUnsignedChar], CInt, Float]]): nk_text_width_f = o
  ...
  opaque type _dummy_array429 = CArray[CUnsignedChar, Nat._1]
  object _dummy_array429: 
    given _tag: Tag[_dummy_array429] = Tag.CArray[CUnsignedChar, Nat._1](Tag.UByte, Tag.Nat1)
    inline def apply(inline o: CArray[CUnsignedChar, Nat._1]): _dummy_array429 = o

  opaque type nk_command_text = CStruct11[nk_command, Ptr[nk_user_font], nk_color, nk_color, CShort, CShort, CUnsignedShort, CUnsignedShort, Float, CInt, CArray[CUnsignedChar, Nat._1]]
  object nk_command_text:
    given _tag: Tag[nk_command_text] = Tag.materializeCStruct11Tag[nk_command, Ptr[nk_user_font], nk_color, nk_color, CShort, CShort, CUnsignedShort, CUnsignedShort, Float, CInt, CArray[CUnsignedChar, Nat._1]]
    extension (struct: nk_command_text)
      ...
      def string: CArray[CUnsignedChar, Nat._1] = struct._11
  ...
  opaque type nk_keyboard = CStruct3[CArray[nk_key, Nat.Digit2[Nat._3, Nat._0]], CArray[CUnsignedChar, Nat.Digit2[Nat._1, Nat._6]], CInt]
  object nk_keyboard:
    given _tag: Tag[nk_keyboard] = Tag.materializeCStruct3Tag[CArray[nk_key, Nat.Digit2[Nat._3, Nat._0]], CArray[CUnsignedChar, Nat.Digit2[Nat._1, Nat._6]], CInt]
    extension (struct: nk_keyboard)
      def keys: CArray[nk_key, Nat.Digit2[Nat._3, Nat._0]] = struct._1
      def text: CArray[CUnsignedChar, Nat.Digit2[Nat._1, Nat._6]] = struct._2
  ...
  opaque type nk_property_state = CStruct11[CInt, CInt, CArray[CUnsignedChar, Nat.Digit2[Nat._6, Nat._4]], CInt, CInt, CInt, CInt, nk_hash, CUnsignedInt, CUnsignedInt, CInt]
  object nk_property_state:
    given _tag: Tag[nk_property_state] = Tag.materializeCStruct11Tag[CInt, CInt, CArray[CUnsignedChar, Nat.Digit2[Nat._6, Nat._4]], CInt, CInt, CInt, CInt, nk_hash, CUnsignedInt, CUnsignedInt, CInt]
    extension (struct: nk_property_state)
      def active: CInt = struct._1
      def prev: CInt = struct._2
      def buffer: CArray[CUnsignedChar, Nat.Digit2[Nat._6, Nat._4]] = struct._3
...
object functions: 
  ...
  def nk_group_get_scroll(_0: Ptr[nk_context], id: Ptr[CUnsignedChar], x_offset: Ptr[nk_uint], y_offset: Ptr[nk_uint]): Unit = extern
  ...
  def nk_textedit_paste(_0: Ptr[nk_text_edit], _1: Ptr[CUnsignedChar], len: CInt): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_style_push_style_item(_0: Ptr[nk_context], _1: Ptr[nk_style_item], _2: nk_style_item): nk_bool = extern

  def nk_str_insert_text_char(_0: Ptr[nk_str], pos: CInt, _2: Ptr[CUnsignedChar], _3: CInt): CInt = extern

  def nk_filter_binary(_0: Ptr[nk_text_edit], unicode: nk_rune): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_label_colored(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags, _3: nk_color): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_symbol_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, align: nk_flags, _4: nk_symbol_type, size: nk_vec2): nk_bool = extern

  def nk_selectable_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, align: nk_flags, value: Ptr[nk_bool]): nk_bool = extern
  ...
  def nk_str_at_const(_0: Ptr[nk_str], pos: CInt, unicode: Ptr[nk_rune], len: Ptr[CInt]): Ptr[CUnsignedChar] = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combobox_callback(_0: Ptr[nk_context], item_getter: Ptr[CFuncPtr3[Ptr[Byte], CInt, Ptr[Ptr[CUnsignedChar]], Unit]], _2: Ptr[Byte], selected: Ptr[CInt], count: CInt, item_height: CInt, size: nk_vec2): Unit = extern
  ...
  def nk_stricmp(s1: Ptr[CUnsignedChar], s2: Ptr[CUnsignedChar]): CInt = extern

  def nk_tree_state_pop(_0: Ptr[nk_context]): Unit = extern

  def nk_style_pop_font(_0: Ptr[nk_context]): nk_bool = extern

  def nk_combo_item_symbol_text(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], _3: CInt, alignment: nk_flags): nk_bool = extern

  def nk_textedit_redo(_0: Ptr[nk_text_edit]): Unit = extern

  def nk_list_view_begin(_0: Ptr[nk_context], out: Ptr[nk_list_view], id: Ptr[CUnsignedChar], _3: nk_flags, row_height: CInt, row_count: CInt): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_rgba_f(r: Float, g: Float, b: Float, a: Float): nk_color = extern

  def nk_radio_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, active: Ptr[nk_bool]): nk_bool = extern
  ...
  def nk_selectable_symbol_text(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], _3: CInt, align: nk_flags, value: Ptr[nk_bool]): nk_bool = extern
  ...
  def nk_style_get_color_by_name(_0: nk_style_colors): Ptr[CUnsignedChar] = extern
  ...
  def nk_selectable_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags, value: Ptr[nk_bool]): nk_bool = extern

  def nk_widget_height(_0: Ptr[nk_context]): Float = extern

  def nk_combo_item_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, alignment: nk_flags): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_tree_state_image_push(_0: Ptr[nk_context], _1: nk_tree_type, _2: nk_image, title: Ptr[CUnsignedChar], state: Ptr[nk_collapse_states]): nk_bool = extern
  ...
  def nk_str_insert_str_utf8(_0: Ptr[nk_str], pos: CInt, _2: Ptr[CUnsignedChar]): CInt = extern
  ...
  def nk_button_symbol_label_styled(ctx: Ptr[nk_context], style: Ptr[nk_style_button], symbol: nk_symbol_type, title: Ptr[CUnsignedChar], align: nk_flags): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_separator(_0: Ptr[nk_context], items_separated_by_separator: Ptr[CUnsignedChar], separator: CInt, selected: CInt, count: CInt, item_height: CInt, size: nk_vec2): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_item_image_label(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_rgba_hex(rgb: Ptr[CUnsignedChar]): nk_color = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_item_image_label(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern

  def nk_checkbox_flags_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], flags: Ptr[CUnsignedInt], value: CUnsignedInt): nk_bool = extern
  ...
  def nk_propertyd(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], min: Double, `val`: Double, max: Double, step: Double, inc_per_pixel: Float): Double = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_contextual_item_image_label(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_symbol_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags, _3: nk_symbol_type, size: nk_vec2): nk_bool = extern

  def nk_contextual_item_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, align: nk_flags): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_draw_text(_0: Ptr[nk_command_buffer], _1: nk_rect, text: Ptr[CUnsignedChar], len: CInt, _4: Ptr[nk_user_font], _5: nk_color, _6: nk_color): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_button_image(_0: Ptr[nk_context], img: nk_image): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_popup_begin(_0: Ptr[nk_context], _1: nk_popup_type, _2: Ptr[CUnsignedChar], _3: nk_flags, bounds: nk_rect): nk_bool = extern

  def nk_menubar_end(_0: Ptr[nk_context]): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combobox_string(_0: Ptr[nk_context], items_separated_by_zeros: Ptr[CUnsignedChar], selected: Ptr[CInt], count: CInt, item_height: CInt, size: nk_vec2): Unit = extern

  def nk_buffer_info(_0: Ptr[nk_memory_status], _1: Ptr[nk_buffer]): Unit = extern

  def nk_combo_item_symbol_label(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern

  def nk_property_double(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], min: Double, `val`: Ptr[Double], max: Double, step: Double, inc_per_pixel: Float): Unit = extern
  ...
  def nk_utf_encode(_0: nk_rune, _1: Ptr[CUnsignedChar], _2: CInt): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_image_id(_0: CInt): nk_image = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_button_image_text_styled(_0: Ptr[nk_context], _1: Ptr[nk_style_button], img: nk_image, _3: Ptr[CUnsignedChar], _4: CInt, alignment: nk_flags): nk_bool = extern
  ...
  def nk_menu_item_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, align: nk_flags): nk_bool = extern

  def nk_handle_ptr(_0: Ptr[Byte]): nk_handle = extern

  def nk_str_insert_str_char(_0: Ptr[nk_str], pos: CInt, _2: Ptr[CUnsignedChar]): CInt = extern

  def nk_style_set_cursor(_0: Ptr[nk_context], _1: nk_style_cursor): nk_bool = extern

  def nk_label_wrap(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar]): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_button_image_label(_0: Ptr[nk_context], img: nk_image, _2: Ptr[CUnsignedChar], text_alignment: nk_flags): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_item_image_text(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], len: CInt, alignment: nk_flags): nk_bool = extern
  ...
  def nk_window_is_hidden(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar]): nk_bool = extern

  def nk_option_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], active: nk_bool): nk_bool = extern

  def nk_stricmpn(s1: Ptr[CUnsignedChar], s2: Ptr[CUnsignedChar], n: CInt): CInt = extern

  def nk_menu_end(_0: Ptr[nk_context]): Unit = extern

  def nk_group_begin_titled(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], title: Ptr[CUnsignedChar], _3: nk_flags): nk_bool = extern

  def nk_layout_row_template_push_dynamic(_0: Ptr[nk_context]): Unit = extern

  def nk_radio_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], active: Ptr[nk_bool]): nk_bool = extern

  def nk_input_char(_0: Ptr[nk_context], _1: CUnsignedChar): Unit = extern
  ...
  def nk_str_insert_text_utf8(_0: Ptr[nk_str], pos: CInt, _2: Ptr[CUnsignedChar], _3: CInt): CInt = extern

  def nk_window_find(ctx: Ptr[nk_context], name: Ptr[CUnsignedChar]): Ptr[nk_window] = extern
  ...
  def nk_tree_element_push_hashed(_0: Ptr[nk_context], _1: nk_tree_type, title: Ptr[CUnsignedChar], initial_state: nk_collapse_states, selected: Ptr[nk_bool], hash: Ptr[CUnsignedChar], len: CInt, seed: CInt): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_symbol(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: nk_symbol_type, size: nk_vec2): nk_bool = extern

  def nk_check_flags_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], flags: CUnsignedInt, value: CUnsignedInt): CUnsignedInt = extern
  ...
  def nk_combo_item_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_window_get_content_region_min(_0: Ptr[nk_context]): nk_vec2 = extern

  def nk_edit_string_zero_terminated(_0: Ptr[nk_context], _1: nk_flags, buffer: Ptr[CUnsignedChar], max: CInt, _4: nk_plugin_filter): nk_flags = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_select_image_text(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], _3: CInt, align: nk_flags, value: nk_bool): nk_bool = extern

  def nk_select_symbol_label(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], align: nk_flags, value: nk_bool): nk_bool = extern

  def nk_str_append_text_char(_0: Ptr[nk_str], _1: Ptr[CUnsignedChar], _2: CInt): CInt = extern

  def nk_select_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, align: nk_flags, value: nk_bool): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_window_get_size(_0: Ptr[nk_context]): nk_vec2 = extern

  def nk_checkbox_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, active: Ptr[nk_bool]): nk_bool = extern

  def nk_strmatch_fuzzy_string(str: Ptr[CUnsignedChar], pattern: Ptr[CUnsignedChar], out_score: Ptr[CInt]): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_window_set_position(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], pos: nk_vec2): Unit = extern
  ...
  def nk_check_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, active: nk_bool): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_item_image_text(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], _3: CInt, alignment: nk_flags): nk_bool = extern
  ...
  def nk_select_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags, value: nk_bool): nk_bool = extern
  ...
  def nk_textedit_text(_0: Ptr[nk_text_edit], _1: Ptr[CUnsignedChar], total_len: CInt): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_input_mouse_clicked(_0: Ptr[nk_input], _1: nk_buttons, _2: nk_rect): nk_bool = extern

  def nk_group_scrolled_begin(_0: Ptr[nk_context], off: Ptr[nk_scroll], title: Ptr[CUnsignedChar], _3: nk_flags): nk_bool = extern
  ...
  def nk_window_is_closed(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar]): nk_bool = extern
  ...
  def nk_button_symbol_label(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], text_alignment: nk_flags): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_text_colored(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, _3: nk_flags, _4: nk_color): Unit = extern
  ...
  def nk_window_close(ctx: Ptr[nk_context], name: Ptr[CUnsignedChar]): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_selectable_image_label(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], align: nk_flags, value: Ptr[nk_bool]): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_text_wrap_colored(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, _3: nk_color): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_image_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags, _3: nk_image, size: nk_vec2): nk_bool = extern
  ...
  def nk_button_symbol_text_styled(_0: Ptr[nk_context], _1: Ptr[nk_style_button], _2: nk_symbol_type, _3: Ptr[CUnsignedChar], _4: CInt, alignment: nk_flags): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_color_hex_rgba(output: Ptr[CUnsignedChar], _1: nk_color): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_begin_symbol_text(_0: Ptr[nk_context], selected: Ptr[CUnsignedChar], _2: CInt, _3: nk_symbol_type, size: nk_vec2): nk_bool = extern

  def nk_group_set_scroll(_0: Ptr[nk_context], id: Ptr[CUnsignedChar], x_offset: nk_uint, y_offset: nk_uint): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_layout_space_to_screen(_0: Ptr[nk_context], _1: nk_vec2): nk_vec2 = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combobox_separator(_0: Ptr[nk_context], items_separated_by_separator: Ptr[CUnsignedChar], separator: CInt, selected: Ptr[CInt], count: CInt, item_height: CInt, size: nk_vec2): Unit = extern

  def nk_str_append_str_utf8(_0: Ptr[nk_str], _1: Ptr[CUnsignedChar]): CInt = extern
  ...
  def nk_edit_string(_0: Ptr[nk_context], _1: nk_flags, buffer: Ptr[CUnsignedChar], len: Ptr[CInt], max: CInt, _5: nk_plugin_filter): nk_flags = extern
  ...
  def nk_tree_push_hashed(_0: Ptr[nk_context], _1: nk_tree_type, title: Ptr[CUnsignedChar], initial_state: nk_collapse_states, hash: Ptr[CUnsignedChar], len: CInt, seed: CInt): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_selectable_image_text(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], _3: CInt, align: nk_flags, value: Ptr[nk_bool]): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_label_colored_wrap(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: nk_color): Unit = extern
  ...
  def nk_str_append_str_char(_0: Ptr[nk_str], _1: Ptr[CUnsignedChar]): CInt = extern
  ...
  def nk_utf_decode(_0: Ptr[CUnsignedChar], _1: Ptr[nk_rune], _2: CInt): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_select_image_label(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], align: nk_flags, value: nk_bool): nk_bool = extern
  ...
  def nk_button_text(_0: Ptr[nk_context], title: Ptr[CUnsignedChar], len: CInt): nk_bool = extern

  def nk_contextual_item_symbol_label(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern

  def nk_button_text_styled(_0: Ptr[nk_context], _1: Ptr[nk_style_button], title: Ptr[CUnsignedChar], len: CInt): nk_bool = extern

  def nk_check_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], active: nk_bool): nk_bool = extern
  ...
  def nk_propertyi(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], min: CInt, `val`: CInt, max: CInt, step: CInt, inc_per_pixel: Float): CInt = extern

  def nk_tree_state_push(_0: Ptr[nk_context], _1: nk_tree_type, title: Ptr[CUnsignedChar], state: Ptr[nk_collapse_states]): nk_bool = extern

  def nk_popup_end(_0: Ptr[nk_context]): Unit = extern

  def nk_str_insert_at_char(_0: Ptr[nk_str], pos: CInt, _2: Ptr[CUnsignedChar], _3: CInt): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_triangle_from_direction(result: Ptr[nk_vec2], r: nk_rect, pad_x: Float, pad_y: Float, _4: nk_heading): Unit = extern

  def nk_strtoi(str: Ptr[CUnsignedChar], endptr: Ptr[Ptr[CUnsignedChar]]): CInt = extern
  ...
  def nk_window_is_active(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar]): nk_bool = extern

  def nk_property_float(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], min: Float, `val`: Ptr[Float], max: Float, step: Float, inc_per_pixel: Float): Unit = extern

  def nk_checkbox_flags_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, flags: Ptr[CUnsignedInt], value: CUnsignedInt): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_begin(ctx: Ptr[nk_context], title: Ptr[CUnsignedChar], bounds: nk_rect, flags: nk_flags): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags, size: nk_vec2): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_rgba_cf(c: nk_colorf): nk_color = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_tree_image_push_hashed(_0: Ptr[nk_context], _1: nk_tree_type, _2: nk_image, title: Ptr[CUnsignedChar], initial_state: nk_collapse_states, hash: Ptr[CUnsignedChar], len: CInt, seed: CInt): nk_bool = extern

  def nk_window_show_if(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], _2: nk_show_states, cond: CInt): Unit = extern

  def nk_button_label_styled(_0: Ptr[nk_context], _1: Ptr[nk_style_button], title: Ptr[CUnsignedChar]): nk_bool = extern

  def nk_tooltip(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar]): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_begin_symbol_label(_0: Ptr[nk_context], selected: Ptr[CUnsignedChar], _2: nk_symbol_type, size: nk_vec2): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_begin_image_text(_0: Ptr[nk_context], selected: Ptr[CUnsignedChar], _2: CInt, _3: nk_image, size: nk_vec2): nk_bool = extern
  ...
  def nk_strtod(str: Ptr[CUnsignedChar], endptr: Ptr[Ptr[CUnsignedChar]]): Double = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_image(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: nk_image, size: nk_vec2): nk_bool = extern

  def nk_str_get(_0: Ptr[nk_str]): Ptr[CUnsignedChar] = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combobox(_0: Ptr[nk_context], items: Ptr[Ptr[CUnsignedChar]], count: CInt, selected: Ptr[CInt], item_height: CInt, size: nk_vec2): Unit = extern
  ...
  def nk_checkbox_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], active: Ptr[nk_bool]): nk_bool = extern
  ...
  def nk_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, _3: nk_flags): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_contextual_item_image_text(_0: Ptr[nk_context], _1: nk_image, _2: Ptr[CUnsignedChar], len: CInt, alignment: nk_flags): nk_bool = extern

  def nk_spacer(_0: Ptr[nk_context]): Unit = extern

  def nk_contextual_item_symbol_text(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], _3: CInt, alignment: nk_flags): nk_bool = extern

  def nk_str_at_rune(_0: Ptr[nk_str], pos: CInt, unicode: Ptr[nk_rune], len: Ptr[CInt]): Ptr[CUnsignedChar] = extern

  def nk_style_show_cursor(_0: Ptr[nk_context]): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_begin_image_label(_0: Ptr[nk_context], selected: Ptr[CUnsignedChar], _2: nk_image, size: nk_vec2): nk_bool = extern

  def nk_strlen(str: Ptr[CUnsignedChar]): CInt = extern

  def nk_str_clear(_0: Ptr[nk_str]): Unit = extern

  def nk_window_set_focus(_0: Ptr[nk_context], name: Ptr[CUnsignedChar]): Unit = extern

  def nk_window_collapse_if(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], _2: nk_collapse_states, cond: CInt): Unit = extern
  ...
  def nk_utf_len(_0: Ptr[CUnsignedChar], byte_len: CInt): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_color_hsva_f(out_h: Ptr[Float], out_s: Ptr[Float], out_v: Ptr[Float], out_a: Ptr[Float], _4: nk_color): Unit = extern

  def nk_str_append_text_utf8(_0: Ptr[nk_str], _1: Ptr[CUnsignedChar], _2: CInt): CInt = extern

  def nk_str_insert_at_rune(_0: Ptr[nk_str], pos: CInt, _2: Ptr[CUnsignedChar], _3: CInt): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_color_u32(_0: nk_color): nk_uint = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_window_set_size(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], _2: nk_vec2): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_rgb_hex(rgb: Ptr[CUnsignedChar]): nk_color = extern

  def nk_str_at_char_const(_0: Ptr[nk_str], pos: CInt): Ptr[CUnsignedChar] = extern

  def nk_str_init(_0: Ptr[nk_str], _1: Ptr[nk_allocator], size: nk_size): Unit = extern

  def nk_option_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, active: nk_bool): nk_bool = extern
  ...
  def nk_check_flags_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, flags: CUnsignedInt, value: CUnsignedInt): CUnsignedInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_rgb_bv(rgb: Ptr[nk_byte]): nk_color = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_begin_text(_0: Ptr[nk_context], selected: Ptr[CUnsignedChar], _2: CInt, size: nk_vec2): nk_bool = extern
  ...
  def nk_group_scrolled_offset_begin(_0: Ptr[nk_context], x_offset: Ptr[nk_uint], y_offset: Ptr[nk_uint], title: Ptr[CUnsignedChar], flags: nk_flags): nk_bool = extern
  ...
  def nk_window_show(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], _2: nk_show_states): Unit = extern

  def nk_propertyf(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], min: Float, `val`: Float, max: Float, step: Float, inc_per_pixel: Float): Float = extern

  def nk_str_at_char(_0: Ptr[nk_str], pos: CInt): Ptr[CUnsignedChar] = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_button_image_text(_0: Ptr[nk_context], img: nk_image, _2: Ptr[CUnsignedChar], _3: CInt, alignment: nk_flags): nk_bool = extern

  def nk_menu_item_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern

  def nk_window_collapse(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], state: nk_collapse_states): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_tree_element_image_push_hashed(_0: Ptr[nk_context], _1: nk_tree_type, _2: nk_image, title: Ptr[CUnsignedChar], initial_state: nk_collapse_states, selected: Ptr[nk_bool], hash: Ptr[CUnsignedChar], len: CInt, seed: CInt): nk_bool = extern
  ...
  def nk_window_is_collapsed(ctx: Ptr[nk_context], name: Ptr[CUnsignedChar]): nk_bool = extern

  def nk_chart_push(_0: Ptr[nk_context], _1: Float): nk_flags = extern

  def nk_str_get_const(_0: Ptr[nk_str]): Ptr[CUnsignedChar] = extern

  def nk_widget_width(_0: Ptr[nk_context]): Float = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_button_image_label_styled(_0: Ptr[nk_context], _1: Ptr[nk_style_button], img: nk_image, _3: Ptr[CUnsignedChar], text_alignment: nk_flags): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_nine_slice_id(_0: CInt, l: nk_ushort, t: nk_ushort, r: nk_ushort, b: nk_ushort): nk_nine_slice = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_window_set_bounds(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], bounds: nk_rect): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_rgba(r: CInt, g: CInt, b: CInt, a: CInt): nk_color = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo(_0: Ptr[nk_context], items: Ptr[Ptr[CUnsignedChar]], count: CInt, selected: CInt, item_height: CInt, size: nk_vec2): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_color_hex_rgb(output: Ptr[CUnsignedChar], _1: nk_color): Unit = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_text(_0: Ptr[nk_context], title: Ptr[CUnsignedChar], title_len: CInt, align: nk_flags, size: nk_vec2): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_widget_bounds(_0: Ptr[nk_context]): nk_rect = extern

  def nk_select_symbol_text(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], _3: CInt, align: nk_flags, value: nk_bool): nk_bool = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_begin_titled(ctx: Ptr[nk_context], name: Ptr[CUnsignedChar], title: Ptr[CUnsignedChar], bounds: nk_rect, flags: nk_flags): nk_bool = extern

  def nk_utf_at(buffer: Ptr[CUnsignedChar], length: CInt, index: CInt, unicode: Ptr[nk_rune], len: Ptr[CInt]): Ptr[CUnsignedChar] = extern
  ...
  def nk_text_wrap(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt): Unit = extern
  ...
  def nk_strfilter(text: Ptr[CUnsignedChar], regexp: Ptr[CUnsignedChar]): CInt = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_menu_begin_image_text(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], _2: CInt, align: nk_flags, _4: nk_image, size: nk_vec2): nk_bool = extern
  ...
  def nk_strtof(str: Ptr[CUnsignedChar], endptr: Ptr[Ptr[CUnsignedChar]]): Float = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_callback(_0: Ptr[nk_context], item_getter: Ptr[CFuncPtr3[Ptr[Byte], CInt, Ptr[Ptr[CUnsignedChar]], Unit]], userdata: Ptr[Byte], selected: CInt, count: CInt, item_height: CInt, size: nk_vec2): CInt = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_string(_0: Ptr[nk_context], items_separated_by_zeros: Ptr[CUnsignedChar], selected: CInt, count: CInt, item_height: CInt, size: nk_vec2): CInt = extern
  ...
  def nk_strmatch_fuzzy_text(txt: Ptr[CUnsignedChar], txt_len: CInt, pattern: Ptr[CUnsignedChar], out_score: Ptr[CInt]): CInt = extern
  ...
  def nk_menu_item_symbol_label(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], alignment: nk_flags): nk_bool = extern
  ...
  def nk_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags): Unit = extern

  def nk_property_int(_0: Ptr[nk_context], name: Ptr[CUnsignedChar], min: CInt, `val`: Ptr[CInt], max: CInt, step: CInt, inc_per_pixel: Float): Unit = extern
  ...
  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_combo_begin_label(_0: Ptr[nk_context], selected: Ptr[CUnsignedChar], size: nk_vec2): nk_bool = extern

  // this function will not work on Scala Native as it has direct Struct parameter or returns a struct
  def nk_hsv(h: CInt, s: CInt, v: CInt): nk_color = extern

  def nk_selectable_symbol_label(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], align: nk_flags, value: Ptr[nk_bool]): nk_bool = extern
  ...
  def nk_group_begin(_0: Ptr[nk_context], title: Ptr[CUnsignedChar], _2: nk_flags): nk_bool = extern
  ...
  def nk_contextual_item_label(_0: Ptr[nk_context], _1: Ptr[CUnsignedChar], align: nk_flags): nk_bool = extern
  ...
  def nk_menu_item_symbol_text(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], _3: CInt, alignment: nk_flags): nk_bool = extern
  ...
  def nk_button_symbol_text(_0: Ptr[nk_context], _1: nk_symbol_type, _2: Ptr[CUnsignedChar], _3: CInt, alignment: nk_flags): nk_bool = extern

  def nk_button_label(_0: Ptr[nk_context], title: Ptr[CUnsignedChar]): nk_bool = extern
