...
void __sn_wrap_nk_hsv_bv(const nk_byte * c, struct nk_color *__return) {
...
void __sn_wrap_nk_hsva_bv(const nk_byte * c, struct nk_color *__return) {
...
void __sn_wrap_nk_hsva_iv(const int * hsva, struct nk_color *__return) {
  nk_color ____ret = nk_hsva_iv(hsva);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_rgb_fv(const float * rgb, struct nk_color *__return) {
  nk_color ____ret = nk_rgb_fv(rgb);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_rgb_iv(const int * rgb, struct nk_color *__return) {
  nk_color ____ret = nk_rgb_iv(rgb);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_rgba_bv(const nk_byte * c, struct nk_color *__return) {
