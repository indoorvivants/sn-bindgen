...
void __sn_wrap_nk_hsv_bv(const nk_byte * hsv, struct nk_color *__return) {
  nk_color ____ret = nk_hsv_bv(hsv);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_hsv_fv(const float * hsv, struct nk_color *__return) {
  nk_color ____ret = nk_hsv_fv(hsv);
  memcpy(__return, &____ret, sizeof(nk_color));
}


void __sn_wrap_nk_hsv_iv(const int * hsv, struct nk_color *__return) {
  nk_color ____ret = nk_hsv_iv(hsv);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_hsva_bv(const nk_byte * hsva, struct nk_color *__return) {
  nk_color ____ret = nk_hsva_bv(hsva);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_hsva_fv(const float * c, struct nk_color *__return) {
  nk_color ____ret = nk_hsva_fv(c);
  memcpy(__return, &____ret, sizeof(nk_color));
}


void __sn_wrap_nk_hsva_iv(const int * c, struct nk_color *__return) {
...
void __sn_wrap_nk_rectiv(const int * r, struct nk_rect *__return) {
  nk_rect ____ret = nk_rectiv(r);
  memcpy(__return, &____ret, sizeof(nk_rect));
}


void __sn_wrap_nk_rectv(const float * r, struct nk_rect *__return) {
...
void __sn_wrap_nk_rgb_bv(const nk_byte * c, struct nk_color *__return) {
...
void __sn_wrap_nk_rgb_fv(const float * c, struct nk_color *__return) {
...
void __sn_wrap_nk_rgb_iv(const int * c, struct nk_color *__return) {
...
void __sn_wrap_nk_rgba_bv(const nk_byte * rgba, struct nk_color *__return) {
  nk_color ____ret = nk_rgba_bv(rgba);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_rgba_fv(const float * rgba, struct nk_color *__return) {
  nk_color ____ret = nk_rgba_fv(rgba);
  memcpy(__return, &____ret, sizeof(nk_color));
}
...
void __sn_wrap_nk_rgba_iv(const int * c, struct nk_color *__return) {
...
void __sn_wrap_nk_vec2iv(const int * xy, struct nk_vec2 *__return) {
  nk_vec2 ____ret = nk_vec2iv(xy);
  memcpy(__return, &____ret, sizeof(nk_vec2));
}


void __sn_wrap_nk_vec2v(const float * v, struct nk_vec2 *__return) {
