...
def info(msg: Any)(using Config) =
  errln(Console.BLUE + "[info] " + Console.RESET + msg.toString)

def warning(msg: Any)(using Config) =
  errln(Console.YELLOW + "[warn] " + Console.RESET + msg.toString)

def error(msg: Any)(using Config) =
  errln(Console.RED + "[error] " + Console.RESET + msg.toString)
