...
object structs:
  ...
  opaque type StructWithUnionArray = CStruct3[CInt, StructWithUnionArray.Union0, CArray[StructWithUnionArray.Union1, Nat._2]]
  object StructWithUnionArray:
    ...
    object Union0:
      ...
      extension (struct: Union0)
        ...
        def test_=(value: CLongInt): Unit = !struct.at(0).asInstanceOf[Ptr[CLongInt]] = value
        def help : CString = !struct.at(0).asInstanceOf[Ptr[CString]]
        def help_=(value: CString): Unit = !struct.at(0).asInstanceOf[Ptr[CString]] = value
    ...
    object Union1:
      ...
      extension (struct: Union1)
        ...
        def help : CString = !struct.at(0).asInstanceOf[Ptr[CString]]
        def help_=(value: CString): Unit = !struct.at(0).asInstanceOf[Ptr[CString]] = value
    given _tag: Tag[StructWithUnionArray] = Tag.materializeCStruct3Tag[CInt, StructWithUnionArray.Union0, CArray[StructWithUnionArray.Union1, Nat._2]]
    def apply()(using Zone): Ptr[StructWithUnionArray] = scala.scalanative.unsafe.alloc[StructWithUnionArray](1)
    def apply(g_type : CInt, yo : StructWithUnionArray.Union0, data : CArray[StructWithUnionArray.Union1, Nat._2])(using Zone): Ptr[StructWithUnionArray] =
      val ____ptr = apply()
    ...
    extension (struct: StructWithUnionArray)
      ...
      def data_=(value: CArray[StructWithUnionArray.Union1, Nat._2]): Unit = !struct.at3 = value

  opaque type struct_with_union_array = CStruct3[CInt, struct_with_union_array.Union0, CArray[struct_with_union_array.Union1, Nat._2]]
  object struct_with_union_array:
    ...
    object Union1:
      ...
      extension (struct: Union1)
        ...
        def help : CString = !struct.at(0).asInstanceOf[Ptr[CString]]
        def help_=(value: CString): Unit = !struct.at(0).asInstanceOf[Ptr[CString]] = value
    given _tag: Tag[struct_with_union_array] = Tag.materializeCStruct3Tag[CInt, struct_with_union_array.Union0, CArray[struct_with_union_array.Union1, Nat._2]]
    def apply()(using Zone): Ptr[struct_with_union_array] = scala.scalanative.unsafe.alloc[struct_with_union_array](1)
    def apply(g_type : CInt, yo : struct_with_union_array.Union0, data : CArray[struct_with_union_array.Union1, Nat._2])(using Zone): Ptr[struct_with_union_array] =
      val ____ptr = apply()
      (!____ptr).g_type = g_type
      (!____ptr).yo = yo
      (!____ptr).data = data
    ...
    extension (struct: struct_with_union_array)
      ...
      def yo_=(value: struct_with_union_array.Union0): Unit = !struct.at2 = value
      def data : CArray[struct_with_union_array.Union1, Nat._2] = struct._3
      def data_=(value: CArray[struct_with_union_array.Union1, Nat._2]): Unit = !struct.at3 = value
...
object unions:
  ...
  opaque type UnionOverlapping = CArray[Byte, Nat.Digit3[Nat._2, Nat._8, Nat._0]]
  object UnionOverlapping:
    given _tag: Tag[UnionOverlapping] = Tag.CArray[CChar, Nat.Digit3[Nat._2, Nat._8, Nat._0]](Tag.Byte, Tag.Digit3[Nat._2, Nat._8, Nat._0](Tag.Nat2, Tag.Nat8, Tag.Nat0))
    ...
    def apply(p: CArray[CLongInt, Nat.Digit2[Nat._3, Nat._5]])(using Zone): Ptr[UnionOverlapping] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[UnionOverlapping](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CArray[CLongInt, Nat.Digit2[Nat._3, Nat._5]]]].update(0, p)
      ___ptr
    @scala.annotation.targetName("apply_d")
    def apply(d: CArray[CChar, Nat.Digit2[Nat._4, Nat._0]])(using Zone): Ptr[UnionOverlapping] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[UnionOverlapping](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._4, Nat._0]]]].update(0, d)
      ___ptr
    extension (struct: UnionOverlapping)
      def p : CArray[CLongInt, Nat.Digit2[Nat._3, Nat._5]] = !struct.at(0).asInstanceOf[Ptr[CArray[CLongInt, Nat.Digit2[Nat._3, Nat._5]]]]
      def p_=(value: CArray[CLongInt, Nat.Digit2[Nat._3, Nat._5]]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[CLongInt, Nat.Digit2[Nat._3, Nat._5]]]] = value
      def d : CArray[CChar, Nat.Digit2[Nat._4, Nat._0]] = !struct.at(0).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._4, Nat._0]]]]
      def d_=(value: CArray[CChar, Nat.Digit2[Nat._4, Nat._0]]): Unit = !struct.at(0).asInstanceOf[Ptr[CArray[CChar, Nat.Digit2[Nat._4, Nat._0]]]] = value
  ...
  object UnionSimple:
    ...
    extension (struct: UnionSimple)
      ...
      def i_=(value: CUnsignedInt): Unit = !struct.at(0).asInstanceOf[Ptr[CUnsignedInt]] = value
      def b : Float = !struct.at(0).asInstanceOf[Ptr[Float]]
      def b_=(value: Float): Unit = !struct.at(0).asInstanceOf[Ptr[Float]] = value
      def s : CString = !struct.at(0).asInstanceOf[Ptr[CString]]
      def s_=(value: CString): Unit = !struct.at(0).asInstanceOf[Ptr[CString]] = value
