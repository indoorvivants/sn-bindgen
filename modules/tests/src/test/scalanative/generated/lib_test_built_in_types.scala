...
object aliases:
  ...
  object fpos_t:
    ...
    extension (v: fpos_t) inline def value: libc.stdio.fpos_t = v
  ...
  object imaxdiv_t:
    ...
    extension (v: imaxdiv_t) inline def value: libc.inttypes.imaxdiv_t = v
...
object structs:
  import _root_.lib_test_built_in_types.aliases.*
  import _root_.lib_test_built_in_types.structs.*
  opaque type SpecialIntTypes =
    CStruct6[int8_t, int16_t, int32_t, uint8_t, uint16_t, uint32_t]
  object SpecialIntTypes:
    given _tag: Tag[SpecialIntTypes] = Tag.materializeCStruct6Tag[
      int8_t,
      int16_t,
      int32_t,
      uint8_t,
    ...
    def apply()(using Zone): Ptr[SpecialIntTypes] =
      scala.scalanative.unsafe.alloc[SpecialIntTypes](1)
    def apply(
        i8: int8_t,
        i16: int16_t,
        i32: int32_t,
        ...
        u16: uint16_t,
        u32: uint32_t
    )(using Zone): Ptr[SpecialIntTypes] =
      val ____ptr = apply()
      (!____ptr).i8 = i8
      (!____ptr).i16 = i16
      (!____ptr).i32 = i32
  ...
  object UsingPosixTypes:
    given _tag: Tag[UsingPosixTypes] =
      Tag.materializeCStruct3Tag[imaxdiv_t, sockaddr, group]
    def apply()(using Zone): Ptr[UsingPosixTypes] =
      scala.scalanative.unsafe.alloc[UsingPosixTypes](1)
    def apply(i1: imaxdiv_t, s2: sockaddr, g1: group)(using
        Zone
    ): Ptr[UsingPosixTypes] =
      val ____ptr = apply()
      (!____ptr).i1 = i1
  ...
  object group:
    ...
    def apply()(using Zone): Ptr[group] =
      scala.scalanative.unsafe.alloc[group](1)
