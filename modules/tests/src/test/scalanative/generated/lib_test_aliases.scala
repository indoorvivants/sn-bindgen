...
object aliases:
  ...
  object TestFunctionPointer:
    given _tag: Tag[TestFunctionPointer] =
      Tag.materializeCFuncPtr1[Ptr[TestStruct], CInt]
    inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): TestFunctionPointer =
      CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
    inline def apply(
        inline o: CFuncPtr1[Ptr[TestStruct], CInt]
    ): TestFunctionPointer = o
    extension (v: TestFunctionPointer)
      inline def value: CFuncPtr1[Ptr[TestStruct], CInt] = v
      inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
  end TestFunctionPointer
  ...
  object alias_of_an_alias:
    ...
    extension (v: alias_of_an_alias) inline def value: hello_alias = v

  opaque type hello_alias = CInt
  object hello_alias:
    given _tag: Tag[hello_alias] = Tag.Int
    inline def apply(inline o: CInt): hello_alias = o
    extension (v: hello_alias) inline def value: CInt = v
end aliases
...
object structs:
  ...
  object AliasesRef:
    ...
    object Union0:
      ...
      extension (struct: Union0)
        ...
        def foo_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] =
          value
    end Union0
    given _tag: Tag[AliasesRef] = Tag.materializeCStruct1Tag[AliasesRef.Union0]
    def apply()(using Zone): Ptr[AliasesRef] =
      scala.scalanative.unsafe.alloc[AliasesRef](1)
  ...
  object TestAliases:
    ...
    object Union0:
      ...
      extension (struct: Union0)
        ...
        def help_=(value: CLongInt): Unit =
          !struct.at(0).asInstanceOf[Ptr[CLongInt]] = value
        def key: CString = !struct.at(0).asInstanceOf[Ptr[CString]]
        def key_=(value: CString): Unit =
          !struct.at(0).asInstanceOf[Ptr[CString]] = value
    end Union0
    given _tag: Tag[TestAliases] =
      Tag.materializeCStruct2Tag[TestAliases.Union0, Ptr[AliasesRef]]
    def apply()(using Zone): Ptr[TestAliases] =
      scala.scalanative.unsafe.alloc[TestAliases](1)
    def apply(field1: TestAliases.Union0, field2: Ptr[AliasesRef])(using
        Zone
    ): Ptr[TestAliases] =
      val ____ptr = apply()
  ...
  object TestStruct:
    ...
    def apply()(using Zone): Ptr[TestStruct] =
      scala.scalanative.unsafe.alloc[TestStruct](1)
...
private[lib_test_aliases] object extern_functions:
  ...
  def higher_order_function(
      n: CInt,
      handler: TestFunctionPointer,
      container: Ptr[TestStruct]
  ): CInt = extern
