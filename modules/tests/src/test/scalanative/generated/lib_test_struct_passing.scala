...
object structs:
  ...
  object FunctionArg:
    ...
    def apply()(using Zone): Ptr[FunctionArg] =
      scala.scalanative.unsafe.alloc[FunctionArg](1)
...
private[lib_test_struct_passing] object extern_functions:
  import _root_.lib_test_struct_passing.structs.*
  private[lib_test_struct_passing] def __sn_wrap_lib_test_struct_passing_function_returning_struct(
      value: CInt,
      __return: Ptr[FunctionArg]
  ): Unit = extern

  private[lib_test_struct_passing] def __sn_wrap_lib_test_struct_passing_function_taking_struct1(
      arg: Ptr[FunctionArg]
  ): CInt = extern

  private[lib_test_struct_passing] def __sn_wrap_lib_test_struct_passing_function_taking_struct2(
      arg1: Ptr[FunctionArg],
      arg2: Ptr[FunctionArg]
  ): CInt = extern
...
object functions:
  ...
  def function_returning_struct(value: CInt)(using Zone): FunctionArg =
    val __ptr_0: Ptr[FunctionArg] =
      _root_.scala.scalanative.unsafe.alloc[FunctionArg](1)
    __sn_wrap_lib_test_struct_passing_function_returning_struct(
      value,
      (__ptr_0 + 0)
    )
    !(__ptr_0 + 0)
  ...
  def function_taking_struct2(
      arg1: Ptr[FunctionArg],
      arg2: Ptr[FunctionArg]
  ): CInt =
    __sn_wrap_lib_test_struct_passing_function_taking_struct2(arg1, arg2)

  def function_taking_struct2(arg1: FunctionArg, arg2: FunctionArg)(using
      Zone
  ): CInt =
    val __ptr_0: Ptr[FunctionArg] =
      _root_.scala.scalanative.unsafe.alloc[FunctionArg](2)
    !(__ptr_0 + 0) = arg1
    !(__ptr_0 + 1) = arg2
    __sn_wrap_lib_test_struct_passing_function_taking_struct2(
      (__ptr_0 + 0),
      (__ptr_0 + 1)
    )
  end function_taking_struct2
end functions
