...
object predef:
    private[lib_test_structs] trait _BindgenEnumCUnsignedInt[T](using eq: T =:= CUnsignedInt):
...
object structs:
  ...
  opaque type StructAnonymous = CStruct3[CInt, StructAnonymous.Union0, StructAnonymous.Struct1]
  object StructAnonymous:
    ...
    object Union0:
      ...
      extension (struct: Union0)
        ...
        def num_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
    ...
    given _tag: Tag[StructAnonymous] = Tag.materializeCStruct3Tag[CInt, StructAnonymous.Union0, StructAnonymous.Struct1]
    def apply()(using Zone): Ptr[StructAnonymous] = scala.scalanative.unsafe.alloc[StructAnonymous](1)
    def apply(x : CInt, context : StructAnonymous.Union0, header : StructAnonymous.Struct1)(using Zone): Ptr[StructAnonymous] =
      val ____ptr = apply()
      (!____ptr).x = x
  ...
  opaque type StructComplex = CStruct8[StructSimple, StructSimple, CInt, StructComplex.Struct0, my_bool, StructComplex.Struct1, CString, CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]]
  object StructComplex:
    ...
    given _tag: Tag[StructComplex] = Tag.materializeCStruct8Tag[StructSimple, StructSimple, CInt, StructComplex.Struct0, my_bool, StructComplex.Struct1, CString, CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]]
    def apply()(using Zone): Ptr[StructComplex] = scala.scalanative.unsafe.alloc[StructComplex](1)
    def apply(p1 : StructSimple, p2 : StructSimple, x : CInt, kiss : StructComplex.Struct0, flag : my_bool, yass : StructComplex.Struct1, bla : CString, test : CArray[CInt, Nat.Digit2[Nat._2, Nat._5]])(using Zone): Ptr[StructComplex] =
      val ____ptr = apply()
      (!____ptr).p1 = p1
      (!____ptr).p2 = p2
      (!____ptr).x = x
    ...
    extension (struct: StructComplex)
      ...
      def test_=(value: CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]): Unit = !struct.at8 = value

  opaque type StructComplexOpaque = CArray[CChar, Nat.Digit3[Nat._2, Nat._1, Nat._6]]
  object StructComplexOpaque:
    ...
    object Union2:
      ...
      extension (struct: Union2)
        ...
        def u0_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
        def u1 : CLongInt = !struct.at(0).asInstanceOf[Ptr[CLongInt]]
        def u1_=(value: CLongInt): Unit = !struct.at(0).asInstanceOf[Ptr[CLongInt]] = value
    ...
    object Union3:
      ...
      extension (struct: Union3)
        ...
        def r0_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
        def r1 : CLongInt = !struct.at(0).asInstanceOf[Ptr[CLongInt]]
        def r1_=(value: CLongInt): Unit = !struct.at(0).asInstanceOf[Ptr[CLongInt]] = value
    ...
    object Union4:
      ...
      extension (struct: Union4)
        ...
        def u1 : CLongInt = !struct.at(0).asInstanceOf[Ptr[CLongInt]]
        def u1_=(value: CLongInt): Unit = !struct.at(0).asInstanceOf[Ptr[CLongInt]] = value
    given _tag: Tag[StructComplexOpaque] = Tag.CArray[CChar, Nat.Digit3[Nat._2, Nat._1, Nat._6]](Tag.Byte, Tag.Digit3[Nat._2, Nat._1, Nat._6](Tag.Nat2, Tag.Nat1, Tag.Nat6))
    def apply()(using Zone): Ptr[StructComplexOpaque] = scala.scalanative.unsafe.alloc[StructComplexOpaque](1)
    def apply(p1 : StructSimple, p2 : StructSimple, x : CInt, kiss : StructComplexOpaque.Struct0, flag : my_bool, yass : StructComplexOpaque.Struct1, bla : CString, test : CArray[CInt, Nat.Digit2[Nat._2, Nat._5]], flan : CArray[StructComplexOpaque.Union3, Nat._2], y : Double, top : StructComplexOpaque.Union4)(using Zone): Ptr[StructComplexOpaque] =
      val ____ptr = apply()
      (!____ptr).p1 = p1
      (!____ptr).p2 = p2
      (!____ptr).x = x
    ...
    extension (struct: StructComplexOpaque)
      def p1: StructSimple = !struct.at(offsets(0)).asInstanceOf[Ptr[StructSimple]]
      def p1_=(value: StructSimple): Unit = !struct.at(offsets(0)).asInstanceOf[Ptr[StructSimple]] = value
      def p2: StructSimple = !struct.at(offsets(1)).asInstanceOf[Ptr[StructSimple]]
      def p2_=(value: StructSimple): Unit = !struct.at(offsets(1)).asInstanceOf[Ptr[StructSimple]] = value
      def x: CInt = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]]
      def x_=(value: CInt): Unit = !struct.at(offsets(2)).asInstanceOf[Ptr[CInt]] = value
      def kiss: StructComplexOpaque.Struct0 = !struct.at(offsets(3)).asInstanceOf[Ptr[StructComplexOpaque.Struct0]]
      def kiss_=(value: StructComplexOpaque.Struct0): Unit = !struct.at(offsets(3)).asInstanceOf[Ptr[StructComplexOpaque.Struct0]] = value
      def flag: my_bool = !struct.at(offsets(4)).asInstanceOf[Ptr[my_bool]]
      def flag_=(value: my_bool): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[my_bool]] = value
      def yass: StructComplexOpaque.Struct1 = !struct.at(offsets(5)).asInstanceOf[Ptr[StructComplexOpaque.Struct1]]
      def yass_=(value: StructComplexOpaque.Struct1): Unit = !struct.at(offsets(5)).asInstanceOf[Ptr[StructComplexOpaque.Struct1]] = value
      def bla: CString = !struct.at(offsets(6)).asInstanceOf[Ptr[CString]]
      def bla_=(value: CString): Unit = !struct.at(offsets(6)).asInstanceOf[Ptr[CString]] = value
      def test: CArray[CInt, Nat.Digit2[Nat._2, Nat._5]] = !struct.at(offsets(8)).asInstanceOf[Ptr[CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]]]
      def test_=(value: CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]]] = value
      def flan: CArray[StructComplexOpaque.Union3, Nat._2] = !struct.at(offsets(9)).asInstanceOf[Ptr[CArray[StructComplexOpaque.Union3, Nat._2]]]
      def flan_=(value: CArray[StructComplexOpaque.Union3, Nat._2]): Unit = !struct.at(offsets(9)).asInstanceOf[Ptr[CArray[StructComplexOpaque.Union3, Nat._2]]] = value
      def y: Double = !struct.at(offsets(10)).asInstanceOf[Ptr[Double]]
      def y_=(value: Double): Unit = !struct.at(offsets(10)).asInstanceOf[Ptr[Double]] = value
      def top: StructComplexOpaque.Union4 = !struct.at(offsets(11)).asInstanceOf[Ptr[StructComplexOpaque.Union4]]
      def top_=(value: StructComplexOpaque.Union4): Unit = !struct.at(offsets(11)).asInstanceOf[Ptr[StructComplexOpaque.Union4]] = value
    val offsets: Array[Int] =
      ...
      res(1) = align(res(0) + sizeof[StructSimple].toInt, alignmentof[StructSimple].toInt)
      res(2) = align(res(1) + sizeof[StructSimple].toInt, alignmentof[CInt].toInt)
      res(3) = align(res(2) + sizeof[CInt].toInt, alignmentof[StructComplexOpaque.Struct0].toInt)
      res(4) = align(res(3) + sizeof[StructComplexOpaque.Struct0].toInt, alignmentof[my_bool].toInt)
      res(5) = align(res(4) + sizeof[my_bool].toInt, alignmentof[StructComplexOpaque.Struct1].toInt)
      res(6) = align(res(5) + sizeof[StructComplexOpaque.Struct1].toInt, alignmentof[CString].toInt)
      res(7) = align(res(6) + sizeof[CString].toInt, Array(alignmentof[CInt].toInt, alignmentof[CLongInt].toInt).max)
      res(8) = align(res(7) + sizeof[CArray[Byte, Nat._8]].toInt, alignmentof[CInt].toInt)
      res(9) = align(res(8) + sizeof[CArray[CInt, Nat.Digit2[Nat._2, Nat._5]]].toInt, Array(alignmentof[CInt].toInt, alignmentof[CLongInt].toInt).max)
      res(10) = align(res(9) + sizeof[CArray[StructComplexOpaque.Union3, Nat._2]].toInt, alignmentof[Double].toInt)
      res(11) = align(res(10) + sizeof[Double].toInt, Array(alignmentof[CInt].toInt, alignmentof[CLongInt].toInt).max)
      res
    end offsets

  opaque type StructSimple = CStruct4[CInt, CInt, CString, CString]
  object StructSimple:
    given _tag: Tag[StructSimple] = Tag.materializeCStruct4Tag[CInt, CInt, CString, CString]
    def apply()(using Zone): Ptr[StructSimple] = scala.scalanative.unsafe.alloc[StructSimple](1)
    def apply(x : CInt, y : CInt, s1 : CString, s2 : CString)(using Zone): Ptr[StructSimple] =
      val ____ptr = apply()
      (!____ptr).x = x
      (!____ptr).y = y
      (!____ptr).s1 = s1
