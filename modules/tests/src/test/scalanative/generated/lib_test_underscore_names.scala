...
object structs:
  ...
  object UnderscoreNamesStruct:
    given _tag: Tag[UnderscoreNamesStruct] = Tag.materializeCStruct3Tag[CInt, CLongInt, CString]
    def apply()(using Zone): Ptr[UnderscoreNamesStruct] = scala.scalanative.unsafe.alloc[UnderscoreNamesStruct](1)
    def apply(`x_` : CInt, `hello_` : CLongInt, $underscore : CString)(using Zone): Ptr[UnderscoreNamesStruct] =
      val ____ptr = apply()
      (!____ptr).`x_` = `x_`
  ...
  object UnderscoreNamesStruct_ :
    ...
    def apply()(using Zone): Ptr[UnderscoreNamesStruct_] = scala.scalanative.unsafe.alloc[UnderscoreNamesStruct_](1)
...
object unions:
  ...
  object UnderscoreNamesUnion:
    given _tag: Tag[UnderscoreNamesUnion] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    def apply()(using Zone): Ptr[UnderscoreNamesUnion] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[UnderscoreNamesUnion](1)
      ___ptr
    ...
    extension (struct: UnderscoreNamesUnion)
      ...
      def x__=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
      def `hello_` : CLongInt = !struct.at(0).asInstanceOf[Ptr[CLongInt]]
      def hello__=(value: CLongInt): Unit = !struct.at(0).asInstanceOf[Ptr[CLongInt]] = value
      def $underscore : CString = !struct.at(0).asInstanceOf[Ptr[CString]]
      def $underscore_=(value: CString): Unit = !struct.at(0).asInstanceOf[Ptr[CString]] = value
