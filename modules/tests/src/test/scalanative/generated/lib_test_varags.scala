...
object structs:
  ...
  object VaragsStruct:
    ...
    def apply()(using Zone): Ptr[VaragsStruct] = scala.scalanative.unsafe.alloc[VaragsStruct](1)
...
private[lib_test_varags] object extern_functions:
  import _root_.lib_test_varags.structs.*
  def test_my_ptrs(vs : Ptr[VaragsStruct], count : CInt, rest: Any*): CInt = extern
