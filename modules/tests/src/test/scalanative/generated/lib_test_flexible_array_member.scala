...
object unions:
  ...
  object FAM_union:
    ...
    extension (struct: FAM_union)
      def va_compressed : FAM_union.Struct0 = !struct.at(0).asInstanceOf[Ptr[FAM_union.Struct0]]
      def va_compressed_=(value: FAM_union.Struct0): Unit = !struct.at(0).asInstanceOf[Ptr[FAM_union.Struct0]] = value
