...
object structs:
  ...
  opaque type AnonymousNestedStruct = CStruct2[AnonymousNestedStruct.Union0, CInt]
  object AnonymousNestedStruct:
    ...
    object Union0:
      ...
      def apply(headgear: AnonymousNestedStruct.Union0.Struct0)(using Zone): Ptr[Union0] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Union0](1)
        val un = !___ptr
        un.at(0).asInstanceOf[Ptr[AnonymousNestedStruct.Union0.Struct0]].update(0, headgear)
        ___ptr
      extension (struct: Union0)
        ...
        def axis_=(value: Float): Unit = !struct.at(0).asInstanceOf[Ptr[Float]] = value
        def headgear : AnonymousNestedStruct.Union0.Struct0 = !struct.at(0).asInstanceOf[Ptr[AnonymousNestedStruct.Union0.Struct0]]
        def headgear_=(value: AnonymousNestedStruct.Union0.Struct0): Unit = !struct.at(0).asInstanceOf[Ptr[AnonymousNestedStruct.Union0.Struct0]] = value
    given _tag: Tag[AnonymousNestedStruct] = Tag.materializeCStruct2Tag[AnonymousNestedStruct.Union0, CInt]
    def apply()(using Zone): Ptr[AnonymousNestedStruct] = scala.scalanative.unsafe.alloc[AnonymousNestedStruct](1)
    def apply(value : AnonymousNestedStruct.Union0, test : CInt)(using Zone): Ptr[AnonymousNestedStruct] = 
      val ____ptr = apply()
      (!____ptr).value = value
      (!____ptr).test = test
      ____ptr
    extension (struct: AnonymousNestedStruct)
      ...
      def value_=(value: AnonymousNestedStruct.Union0): Unit = !struct.at1 = value
  ...
  object AnonymousNestedUnion:
    ...
    object Union0:
      ...
      def apply(axis: Float)(using Zone): Ptr[Union0] =
        ...
        ___ptr
      @scala.annotation.targetName("apply_headgear")
      def apply(headgear: AnonymousNestedUnion.Union0.Struct0)(using Zone): Ptr[Union0] =
        val ___ptr = _root_.scala.scalanative.unsafe.alloc[Union0](1)
        val un = !___ptr
        un.at(0).asInstanceOf[Ptr[AnonymousNestedUnion.Union0.Struct0]].update(0, headgear)
        ___ptr
      extension (struct: Union0)
        def button : CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
        def button_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
        def axis : Float = !struct.at(0).asInstanceOf[Ptr[Float]]
        def axis_=(value: Float): Unit = !struct.at(0).asInstanceOf[Ptr[Float]] = value
        def headgear : AnonymousNestedUnion.Union0.Struct0 = !struct.at(0).asInstanceOf[Ptr[AnonymousNestedUnion.Union0.Struct0]]
        def headgear_=(value: AnonymousNestedUnion.Union0.Struct0): Unit = !struct.at(0).asInstanceOf[Ptr[AnonymousNestedUnion.Union0.Struct0]] = value
    given _tag: Tag[AnonymousNestedUnion] = Tag.CArray[CChar, Nat._8](Tag.Byte, Tag.Nat8)
    def apply()(using Zone): Ptr[AnonymousNestedUnion] = 
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AnonymousNestedUnion](1)
      ___ptr
    @scala.annotation.targetName("apply_value")
    def apply(value: AnonymousNestedUnion.Union0)(using Zone): Ptr[AnonymousNestedUnion] =
      val ___ptr = _root_.scala.scalanative.unsafe.alloc[AnonymousNestedUnion](1)
      val un = !___ptr
    ...
    extension (struct: AnonymousNestedUnion)
      def value : AnonymousNestedUnion.Union0 = !struct.at(0).asInstanceOf[Ptr[AnonymousNestedUnion.Union0]]
      def value_=(value: AnonymousNestedUnion.Union0): Unit = !struct.at(0).asInstanceOf[Ptr[AnonymousNestedUnion.Union0]] = value
      def test : CInt = !struct.at(0).asInstanceOf[Ptr[CInt]]
      def test_=(value: CInt): Unit = !struct.at(0).asInstanceOf[Ptr[CInt]] = value
