...
object CXCursorSet: 
  ...
  extension (v: CXCursorSet)
    inline def value: Ptr[CXCursorSetImpl] = v
...
object CXCursorVisitor: 
  ...
  extension (v: CXCursorVisitor)
    inline def value: CFuncPtr3[CXCursor, CXCursor, CXClientData, CXChildVisitResult] = v
...
object CXInclusionVisitor: 
  ...
  extension (v: CXInclusionVisitor)
    inline def value: CFuncPtr4[CXFile, Ptr[CXSourceLocation], CUnsignedInt, CXClientData, Unit] = v
    inline def toPtr: CVoidPtr = CFuncPtr.toPtr(v)
...
object CXTargetInfo: 
  ...
  extension (v: CXTargetInfo)
    inline def value: Ptr[CXTargetInfoImpl] = v
