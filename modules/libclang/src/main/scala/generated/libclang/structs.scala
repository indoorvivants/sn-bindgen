...
object CXCursorAndRangeVisitor:
  ...
  extension (struct: CXCursorAndRangeVisitor)
    ...
    def visit : CFuncPtr3[Ptr[Byte], CXCursor, CXSourceRange, CXVisitorResult] = struct._2
    def visit_=(value: CFuncPtr3[Ptr[Byte], CXCursor, CXSourceRange, CXVisitorResult]): Unit = !struct.at2 = value
...
object CXIndexOptions:
  ...
  extension (struct: CXIndexOptions)
    ...
    def ThreadBackgroundPriorityForIndexing : CUnsignedChar = struct._2
    def ThreadBackgroundPriorityForIndexing_=(value: CUnsignedChar): Unit = !struct.at2 = value
    def ThreadBackgroundPriorityForEditing : CUnsignedChar = struct._3
    def ThreadBackgroundPriorityForEditing_=(value: CUnsignedChar): Unit = !struct.at3 = value
    def ExcludeDeclarationsFromPCH : CUnsignedInt = struct._4
    def ExcludeDeclarationsFromPCH_=(value: CUnsignedInt): Unit = !struct.at4 = value
    def DisplayDiagnostics : CUnsignedInt = struct._5
...
object IndexerCallbacks:
  ...
  extension (struct: IndexerCallbacks)
    ...
    def abortQuery_=(value: CFuncPtr2[CXClientData, Ptr[Byte], CInt]): Unit = !struct.at1 = value
    def diagnostic : CFuncPtr3[CXClientData, CXDiagnosticSet, Ptr[Byte], Unit] = struct._2
    def diagnostic_=(value: CFuncPtr3[CXClientData, CXDiagnosticSet, Ptr[Byte], Unit]): Unit = !struct.at2 = value
    def enteredMainFile : CFuncPtr3[CXClientData, CXFile, Ptr[Byte], CXIdxClientFile] = struct._3
    def enteredMainFile_=(value: CFuncPtr3[CXClientData, CXFile, Ptr[Byte], CXIdxClientFile]): Unit = !struct.at3 = value
    def ppIncludedFile : CFuncPtr2[CXClientData, Ptr[CXIdxIncludedFileInfo], CXIdxClientFile] = struct._4
    def ppIncludedFile_=(value: CFuncPtr2[CXClientData, Ptr[CXIdxIncludedFileInfo], CXIdxClientFile]): Unit = !struct.at4 = value
    def importedASTFile : CFuncPtr2[CXClientData, Ptr[CXIdxImportedASTFileInfo], CXIdxClientASTFile] = struct._5
    def importedASTFile_=(value: CFuncPtr2[CXClientData, Ptr[CXIdxImportedASTFileInfo], CXIdxClientASTFile]): Unit = !struct.at5 = value
    def startedTranslationUnit : CFuncPtr2[CXClientData, Ptr[Byte], CXIdxClientContainer] = struct._6
    def startedTranslationUnit_=(value: CFuncPtr2[CXClientData, Ptr[Byte], CXIdxClientContainer]): Unit = !struct.at6 = value
    def indexDeclaration : CFuncPtr2[CXClientData, Ptr[CXIdxDeclInfo], Unit] = struct._7
    def indexDeclaration_=(value: CFuncPtr2[CXClientData, Ptr[CXIdxDeclInfo], Unit]): Unit = !struct.at7 = value
    def indexEntityReference : CFuncPtr2[CXClientData, Ptr[CXIdxEntityRefInfo], Unit] = struct._8
    def indexEntityReference_=(value: CFuncPtr2[CXClientData, Ptr[CXIdxEntityRefInfo], Unit]): Unit = !struct.at8 = value

/**
 * [bindgen] header: /usr/lib/llvm-17/include/clang-c/Index.h
*/
opaque type _CXChildVisitResult = CStruct0
object _CXChildVisitResult:
  given _tag: Tag[_CXChildVisitResult] = Tag.materializeCStruct0Tag

/**
 * [bindgen] header: /usr/lib/llvm-17/include/clang-c/Index.h
*/
opaque type _CXCursorAndRangeVisitorBlock = CStruct0
object _CXCursorAndRangeVisitorBlock:
  given _tag: Tag[_CXCursorAndRangeVisitorBlock] = Tag.materializeCStruct0Tag