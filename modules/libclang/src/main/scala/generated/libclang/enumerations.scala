...
object CXCodeComplete_Flags extends CEnumU[CXCodeComplete_Flags]:
  ...
  inline def getName(inline value: CXCodeComplete_Flags): Option[String] =
    inline value match
      ...
      case CXCodeComplete_IncludeCodePatterns =>
        Some("CXCodeComplete_IncludeCodePatterns")
      case CXCodeComplete_IncludeBriefComments =>
        Some("CXCodeComplete_IncludeBriefComments")
      case CXCodeComplete_SkipPreamble => Some("CXCodeComplete_SkipPreamble")
      case CXCodeComplete_IncludeCompletionsWithFixIts =>
        Some("CXCodeComplete_IncludeCompletionsWithFixIts")
      case _ => None
  ...
  inline def getName(inline value: CXCompletionChunkKind): Option[String] =
    inline value match
      ...
      case CXCompletionChunk_Placeholder =>
        Some("CXCompletionChunk_Placeholder")
      case CXCompletionChunk_Informative =>
        Some("CXCompletionChunk_Informative")
      case CXCompletionChunk_CurrentParameter =>
        Some("CXCompletionChunk_CurrentParameter")
      ...
      case CXCompletionChunk_LeftBracket =>
        Some("CXCompletionChunk_LeftBracket")
      case CXCompletionChunk_RightBracket =>
        Some("CXCompletionChunk_RightBracket")
      ...
      case CXCompletionChunk_HorizontalSpace =>
        Some("CXCompletionChunk_HorizontalSpace")
      case CXCompletionChunk_VerticalSpace =>
        Some("CXCompletionChunk_VerticalSpace")
      case _ => None
...
object CXCompletionContext extends CEnumU[CXCompletionContext]:
  ...
  inline def getName(inline value: CXCompletionContext): Option[String] =
    inline value match
      case CXCompletionContext_Unexposed =>
        Some("CXCompletionContext_Unexposed")
      ...
      case CXCompletionContext_ObjCObjectValue =>
        Some("CXCompletionContext_ObjCObjectValue")
      case CXCompletionContext_ObjCSelectorValue =>
        Some("CXCompletionContext_ObjCSelectorValue")
      case CXCompletionContext_CXXClassTypeValue =>
        Some("CXCompletionContext_CXXClassTypeValue")
      case CXCompletionContext_DotMemberAccess =>
        Some("CXCompletionContext_DotMemberAccess")
      case CXCompletionContext_ArrowMemberAccess =>
        Some("CXCompletionContext_ArrowMemberAccess")
      case CXCompletionContext_ObjCPropertyAccess =>
        Some("CXCompletionContext_ObjCPropertyAccess")
      ...
      case CXCompletionContext_StructTag =>
        Some("CXCompletionContext_StructTag")
      case CXCompletionContext_ClassTag => Some("CXCompletionContext_ClassTag")
      case CXCompletionContext_Namespace =>
        Some("CXCompletionContext_Namespace")
      case CXCompletionContext_NestedNameSpecifier =>
        Some("CXCompletionContext_NestedNameSpecifier")
      case CXCompletionContext_ObjCInterface =>
        Some("CXCompletionContext_ObjCInterface")
      case CXCompletionContext_ObjCProtocol =>
        Some("CXCompletionContext_ObjCProtocol")
      case CXCompletionContext_ObjCCategory =>
        Some("CXCompletionContext_ObjCCategory")
      case CXCompletionContext_ObjCInstanceMessage =>
        Some("CXCompletionContext_ObjCInstanceMessage")
      case CXCompletionContext_ObjCClassMessage =>
        Some("CXCompletionContext_ObjCClassMessage")
      case CXCompletionContext_ObjCSelectorName =>
        Some("CXCompletionContext_ObjCSelectorName")
      case CXCompletionContext_MacroName =>
        Some("CXCompletionContext_MacroName")
      case CXCompletionContext_NaturalLanguage =>
        Some("CXCompletionContext_NaturalLanguage")
      case CXCompletionContext_IncludedFile =>
        Some("CXCompletionContext_IncludedFile")
  ...
  inline def getName(inline value: CXCursorKind): Option[String] =
    inline value match
      ...
      case CXCursor_ObjCInstanceMethodDecl =>
        Some("CXCursor_ObjCInstanceMethodDecl")
      case CXCursor_ObjCClassMethodDecl => Some("CXCursor_ObjCClassMethodDecl")
      case CXCursor_ObjCImplementationDecl =>
        Some("CXCursor_ObjCImplementationDecl")
      case CXCursor_ObjCCategoryImplDecl =>
        Some("CXCursor_ObjCCategoryImplDecl")
      ...
      case CXCursor_TemplateTypeParameter =>
        Some("CXCursor_TemplateTypeParameter")
      case CXCursor_NonTypeTemplateParameter =>
        Some("CXCursor_NonTypeTemplateParameter")
      case CXCursor_TemplateTemplateParameter =>
        Some("CXCursor_TemplateTemplateParameter")
      ...
      case CXCursor_ClassTemplatePartialSpecialization =>
        Some("CXCursor_ClassTemplatePartialSpecialization")
      ...
      case CXCursor_CompoundAssignOperator =>
        Some("CXCursor_CompoundAssignOperator")
      ...
      case CXCursor_GenericSelectionExpr =>
        Some("CXCursor_GenericSelectionExpr")
      ...
      case CXCursor_CXXReinterpretCastExpr =>
        Some("CXCursor_CXXReinterpretCastExpr")
      case CXCursor_CXXConstCastExpr => Some("CXCursor_CXXConstCastExpr")
      case CXCursor_CXXFunctionalCastExpr =>
        Some("CXCursor_CXXFunctionalCastExpr")
      ...
      case CXCursor_CXXNullPtrLiteralExpr =>
        Some("CXCursor_CXXNullPtrLiteralExpr")
      ...
      case CXCursor_ObjCAvailabilityCheckExpr =>
        Some("CXCursor_ObjCAvailabilityCheckExpr")
      ...
      case CXCursor_CXXParenListInitExpr =>
        Some("CXCursor_CXXParenListInitExpr")
      ...
      case CXCursor_ObjCAtSynchronizedStmt =>
        Some("CXCursor_ObjCAtSynchronizedStmt")
      case CXCursor_ObjCAutoreleasePoolStmt =>
        Some("CXCursor_ObjCAutoreleasePoolStmt")
      case CXCursor_ObjCForCollectionStmt =>
        Some("CXCursor_ObjCForCollectionStmt")
      ...
      case CXCursor_OMPParallelDirective =>
        Some("CXCursor_OMPParallelDirective")
      ...
      case CXCursor_OMPSectionsDirective =>
        Some("CXCursor_OMPSectionsDirective")
      ...
      case CXCursor_OMPParallelForDirective =>
        Some("CXCursor_OMPParallelForDirective")
      case CXCursor_OMPParallelSectionsDirective =>
        Some("CXCursor_OMPParallelSectionsDirective")
      ...
      case CXCursor_OMPParallelForSimdDirective =>
        Some("CXCursor_OMPParallelForSimdDirective")
      ...
      case CXCursor_OMPTaskgroupDirective =>
        Some("CXCursor_OMPTaskgroupDirective")
      case CXCursor_OMPCancellationPointDirective =>
        Some("CXCursor_OMPCancellationPointDirective")
      case CXCursor_OMPCancelDirective => Some("CXCursor_OMPCancelDirective")
      case CXCursor_OMPTargetDataDirective =>
        Some("CXCursor_OMPTargetDataDirective")
      case CXCursor_OMPTaskLoopDirective =>
        Some("CXCursor_OMPTaskLoopDirective")
      case CXCursor_OMPTaskLoopSimdDirective =>
        Some("CXCursor_OMPTaskLoopSimdDirective")
      case CXCursor_OMPDistributeDirective =>
        Some("CXCursor_OMPDistributeDirective")
      case CXCursor_OMPTargetEnterDataDirective =>
        Some("CXCursor_OMPTargetEnterDataDirective")
      case CXCursor_OMPTargetExitDataDirective =>
        Some("CXCursor_OMPTargetExitDataDirective")
      case CXCursor_OMPTargetParallelDirective =>
        Some("CXCursor_OMPTargetParallelDirective")
      case CXCursor_OMPTargetParallelForDirective =>
        Some("CXCursor_OMPTargetParallelForDirective")
      case CXCursor_OMPTargetUpdateDirective =>
        Some("CXCursor_OMPTargetUpdateDirective")
      case CXCursor_OMPDistributeParallelForDirective =>
        Some("CXCursor_OMPDistributeParallelForDirective")
      case CXCursor_OMPDistributeParallelForSimdDirective =>
        Some("CXCursor_OMPDistributeParallelForSimdDirective")
      case CXCursor_OMPDistributeSimdDirective =>
        Some("CXCursor_OMPDistributeSimdDirective")
      case CXCursor_OMPTargetParallelForSimdDirective =>
        Some("CXCursor_OMPTargetParallelForSimdDirective")
      case CXCursor_OMPTargetSimdDirective =>
        Some("CXCursor_OMPTargetSimdDirective")
      case CXCursor_OMPTeamsDistributeDirective =>
        Some("CXCursor_OMPTeamsDistributeDirective")
      case CXCursor_OMPTeamsDistributeSimdDirective =>
        Some("CXCursor_OMPTeamsDistributeSimdDirective")
      case CXCursor_OMPTeamsDistributeParallelForSimdDirective =>
        Some("CXCursor_OMPTeamsDistributeParallelForSimdDirective")
      case CXCursor_OMPTeamsDistributeParallelForDirective =>
        Some("CXCursor_OMPTeamsDistributeParallelForDirective")
      case CXCursor_OMPTargetTeamsDirective =>
        Some("CXCursor_OMPTargetTeamsDirective")
      case CXCursor_OMPTargetTeamsDistributeDirective =>
        Some("CXCursor_OMPTargetTeamsDistributeDirective")
      case CXCursor_OMPTargetTeamsDistributeParallelForDirective =>
        Some("CXCursor_OMPTargetTeamsDistributeParallelForDirective")
      case CXCursor_OMPTargetTeamsDistributeParallelForSimdDirective =>
        Some("CXCursor_OMPTargetTeamsDistributeParallelForSimdDirective")
      case CXCursor_OMPTargetTeamsDistributeSimdDirective =>
        Some("CXCursor_OMPTargetTeamsDistributeSimdDirective")
      case CXCursor_BuiltinBitCastExpr => Some("CXCursor_BuiltinBitCastExpr")
      case CXCursor_OMPMasterTaskLoopDirective =>
        Some("CXCursor_OMPMasterTaskLoopDirective")
      case CXCursor_OMPParallelMasterTaskLoopDirective =>
        Some("CXCursor_OMPParallelMasterTaskLoopDirective")
      case CXCursor_OMPMasterTaskLoopSimdDirective =>
        Some("CXCursor_OMPMasterTaskLoopSimdDirective")
      case CXCursor_OMPParallelMasterTaskLoopSimdDirective =>
        Some("CXCursor_OMPParallelMasterTaskLoopSimdDirective")
      case CXCursor_OMPParallelMasterDirective =>
        Some("CXCursor_OMPParallelMasterDirective")
      ...
      case CXCursor_OMPDispatchDirective =>
        Some("CXCursor_OMPDispatchDirective")
      ...
      case CXCursor_IBOutletCollectionAttr =>
        Some("CXCursor_IBOutletCollectionAttr")
      ...
      case CXCursor_NSReturnsNotRetained =>
        Some("CXCursor_NSReturnsNotRetained")
      case CXCursor_NSReturnsAutoreleased =>
        Some("CXCursor_NSReturnsAutoreleased")
      ...
      case CXCursor_ObjCSubclassingRestricted =>
        Some("CXCursor_ObjCSubclassingRestricted")
      case CXCursor_ObjCExplicitProtocolImpl =>
        Some("CXCursor_ObjCExplicitProtocolImpl")
      case CXCursor_ObjCDesignatedInitializer =>
        Some("CXCursor_ObjCDesignatedInitializer")
      ...
      case CXCursor_PreprocessingDirective =>
        Some("CXCursor_PreprocessingDirective")
...
object CXCursor_ExceptionSpecificationKind
    extends CEnumU[CXCursor_ExceptionSpecificationKind]:
  given _tag: Tag[CXCursor_ExceptionSpecificationKind] = Tag.UInt
  inline def define(inline a: Long): CXCursor_ExceptionSpecificationKind =
    a.toUInt
  ...
  inline def getName(
      inline value: CXCursor_ExceptionSpecificationKind
  ): Option[String] =
    inline value match
      case CXCursor_ExceptionSpecificationKind_None =>
        Some("CXCursor_ExceptionSpecificationKind_None")
      case CXCursor_ExceptionSpecificationKind_DynamicNone =>
        Some("CXCursor_ExceptionSpecificationKind_DynamicNone")
      case CXCursor_ExceptionSpecificationKind_Dynamic =>
        Some("CXCursor_ExceptionSpecificationKind_Dynamic")
      case CXCursor_ExceptionSpecificationKind_MSAny =>
        Some("CXCursor_ExceptionSpecificationKind_MSAny")
      case CXCursor_ExceptionSpecificationKind_BasicNoexcept =>
        Some("CXCursor_ExceptionSpecificationKind_BasicNoexcept")
      case CXCursor_ExceptionSpecificationKind_ComputedNoexcept =>
        Some("CXCursor_ExceptionSpecificationKind_ComputedNoexcept")
      case CXCursor_ExceptionSpecificationKind_Unevaluated =>
        Some("CXCursor_ExceptionSpecificationKind_Unevaluated")
      case CXCursor_ExceptionSpecificationKind_Uninstantiated =>
        Some("CXCursor_ExceptionSpecificationKind_Uninstantiated")
      case CXCursor_ExceptionSpecificationKind_Unparsed =>
        Some("CXCursor_ExceptionSpecificationKind_Unparsed")
      case CXCursor_ExceptionSpecificationKind_NoThrow =>
        Some("CXCursor_ExceptionSpecificationKind_NoThrow")
      case _ => None
  extension (a: CXCursor_ExceptionSpecificationKind)
    inline def &(
        b: CXCursor_ExceptionSpecificationKind
    ): CXCursor_ExceptionSpecificationKind = a & b
    inline def |(
        b: CXCursor_ExceptionSpecificationKind
    ): CXCursor_ExceptionSpecificationKind = a | b
    inline def is(b: CXCursor_ExceptionSpecificationKind): Boolean =
      (a & b) == b
...
object CXDiagnosticDisplayOptions extends CEnumU[CXDiagnosticDisplayOptions]:
  ...
  inline def getName(inline value: CXDiagnosticDisplayOptions): Option[String] =
    inline value match
      case CXDiagnostic_DisplaySourceLocation =>
        Some("CXDiagnostic_DisplaySourceLocation")
      case CXDiagnostic_DisplayColumn => Some("CXDiagnostic_DisplayColumn")
      case CXDiagnostic_DisplaySourceRanges =>
        Some("CXDiagnostic_DisplaySourceRanges")
      case CXDiagnostic_DisplayOption => Some("CXDiagnostic_DisplayOption")
      case CXDiagnostic_DisplayCategoryId =>
        Some("CXDiagnostic_DisplayCategoryId")
      case CXDiagnostic_DisplayCategoryName =>
        Some("CXDiagnostic_DisplayCategoryName")
      case _ => None
  extension (a: CXDiagnosticDisplayOptions)
    inline def &(b: CXDiagnosticDisplayOptions): CXDiagnosticDisplayOptions =
      a & b
    inline def |(b: CXDiagnosticDisplayOptions): CXDiagnosticDisplayOptions =
      a | b
    inline def is(b: CXDiagnosticDisplayOptions): Boolean = (a & b) == b
end CXDiagnosticDisplayOptions
...
object CXGlobalOptFlags extends CEnumU[CXGlobalOptFlags]:
  ...
  inline def getName(inline value: CXGlobalOptFlags): Option[String] =
    inline value match
      ...
      case CXGlobalOpt_ThreadBackgroundPriorityForIndexing =>
        Some("CXGlobalOpt_ThreadBackgroundPriorityForIndexing")
      case CXGlobalOpt_ThreadBackgroundPriorityForEditing =>
        Some("CXGlobalOpt_ThreadBackgroundPriorityForEditing")
      case CXGlobalOpt_ThreadBackgroundPriorityForAll =>
        Some("CXGlobalOpt_ThreadBackgroundPriorityForAll")
      case _ => None
  ...
  inline def getName(inline value: CXIdxEntityCXXTemplateKind): Option[String] =
    inline value match
      ...
      case CXIdxEntity_TemplatePartialSpecialization =>
        Some("CXIdxEntity_TemplatePartialSpecialization")
      case CXIdxEntity_TemplateSpecialization =>
        Some("CXIdxEntity_TemplateSpecialization")
      case _ => None
  extension (a: CXIdxEntityCXXTemplateKind)
    inline def &(b: CXIdxEntityCXXTemplateKind): CXIdxEntityCXXTemplateKind =
      a & b
    inline def |(b: CXIdxEntityCXXTemplateKind): CXIdxEntityCXXTemplateKind =
      a | b
  ...
  inline def getName(inline value: CXIdxEntityKind): Option[String] =
    inline value match
      ...
      case CXIdxEntity_ObjCInstanceMethod =>
        Some("CXIdxEntity_ObjCInstanceMethod")
      ...
      case CXIdxEntity_CXXNamespaceAlias =>
        Some("CXIdxEntity_CXXNamespaceAlias")
      case CXIdxEntity_CXXStaticVariable =>
        Some("CXIdxEntity_CXXStaticVariable")
      case CXIdxEntity_CXXStaticMethod => Some("CXIdxEntity_CXXStaticMethod")
      case CXIdxEntity_CXXInstanceMethod =>
        Some("CXIdxEntity_CXXInstanceMethod")
...
object CXIndexOptFlags extends CEnumU[CXIndexOptFlags]:
  ...
  inline def getName(inline value: CXIndexOptFlags): Option[String] =
    inline value match
      ...
      case CXIndexOpt_SuppressRedundantRefs =>
        Some("CXIndexOpt_SuppressRedundantRefs")
      case CXIndexOpt_IndexFunctionLocalSymbols =>
        Some("CXIndexOpt_IndexFunctionLocalSymbols")
      case CXIndexOpt_IndexImplicitTemplateInstantiations =>
        Some("CXIndexOpt_IndexImplicitTemplateInstantiations")
      case CXIndexOpt_SuppressWarnings => Some("CXIndexOpt_SuppressWarnings")
      case CXIndexOpt_SkipParsedBodiesInSession =>
        Some("CXIndexOpt_SkipParsedBodiesInSession")
      case _ => None
...
object CXObjCPropertyAttrKind extends CEnumU[CXObjCPropertyAttrKind]:
  ...
  inline def getName(inline value: CXObjCPropertyAttrKind): Option[String] =
    inline value match
      ...
      case CXObjCPropertyAttr_unsafe_unretained =>
        Some("CXObjCPropertyAttr_unsafe_unretained")
  ...
  inline def getName(inline value: CXPrintingPolicyProperty): Option[String] =
    inline value match
      ...
      case CXPrintingPolicy_SuppressSpecifiers =>
        Some("CXPrintingPolicy_SuppressSpecifiers")
      case CXPrintingPolicy_SuppressTagKeyword =>
        Some("CXPrintingPolicy_SuppressTagKeyword")
      case CXPrintingPolicy_IncludeTagDefinition =>
        Some("CXPrintingPolicy_IncludeTagDefinition")
      case CXPrintingPolicy_SuppressScope =>
        Some("CXPrintingPolicy_SuppressScope")
      case CXPrintingPolicy_SuppressUnwrittenScope =>
        Some("CXPrintingPolicy_SuppressUnwrittenScope")
      case CXPrintingPolicy_SuppressInitializers =>
        Some("CXPrintingPolicy_SuppressInitializers")
      case CXPrintingPolicy_ConstantArraySizeAsWritten =>
        Some("CXPrintingPolicy_ConstantArraySizeAsWritten")
      case CXPrintingPolicy_AnonymousTagLocations =>
        Some("CXPrintingPolicy_AnonymousTagLocations")
      case CXPrintingPolicy_SuppressStrongLifetime =>
        Some("CXPrintingPolicy_SuppressStrongLifetime")
      case CXPrintingPolicy_SuppressLifetimeQualifiers =>
        Some("CXPrintingPolicy_SuppressLifetimeQualifiers")
      case CXPrintingPolicy_SuppressTemplateArgsInCXXConstructors =>
        Some("CXPrintingPolicy_SuppressTemplateArgsInCXXConstructors")
      ...
      case CXPrintingPolicy_IncludeNewlines =>
        Some("CXPrintingPolicy_IncludeNewlines")
      case CXPrintingPolicy_MSVCFormatting =>
        Some("CXPrintingPolicy_MSVCFormatting")
      case CXPrintingPolicy_ConstantsAsWritten =>
        Some("CXPrintingPolicy_ConstantsAsWritten")
      case CXPrintingPolicy_SuppressImplicitBase =>
        Some("CXPrintingPolicy_SuppressImplicitBase")
      case CXPrintingPolicy_FullyQualifiedName =>
        Some("CXPrintingPolicy_FullyQualifiedName")
      case CXPrintingPolicy_LastProperty =>
        Some("CXPrintingPolicy_LastProperty")
      case _ => None
  ...
  inline def getName(inline value: CXSaveError): Option[String] =
    inline value match
      ...
      case CXSaveError_TranslationErrors =>
        Some("CXSaveError_TranslationErrors")
  ...
  inline def getName(inline value: CXTUResourceUsageKind): Option[String] =
    inline value match
      ...
      case CXTUResourceUsage_Identifiers =>
        Some("CXTUResourceUsage_Identifiers")
      case CXTUResourceUsage_Selectors => Some("CXTUResourceUsage_Selectors")
      case CXTUResourceUsage_GlobalCompletionResults =>
        Some("CXTUResourceUsage_GlobalCompletionResults")
      case CXTUResourceUsage_SourceManagerContentCache =>
        Some("CXTUResourceUsage_SourceManagerContentCache")
      case CXTUResourceUsage_AST_SideTables =>
        Some("CXTUResourceUsage_AST_SideTables")
      case CXTUResourceUsage_SourceManager_Membuffer_Malloc =>
        Some("CXTUResourceUsage_SourceManager_Membuffer_Malloc")
      case CXTUResourceUsage_SourceManager_Membuffer_MMap =>
        Some("CXTUResourceUsage_SourceManager_Membuffer_MMap")
      case CXTUResourceUsage_ExternalASTSource_Membuffer_Malloc =>
        Some("CXTUResourceUsage_ExternalASTSource_Membuffer_Malloc")
      case CXTUResourceUsage_ExternalASTSource_Membuffer_MMap =>
        Some("CXTUResourceUsage_ExternalASTSource_Membuffer_MMap")
      case CXTUResourceUsage_Preprocessor =>
        Some("CXTUResourceUsage_Preprocessor")
      case CXTUResourceUsage_PreprocessingRecord =>
        Some("CXTUResourceUsage_PreprocessingRecord")
      case CXTUResourceUsage_SourceManager_DataStructures =>
        Some("CXTUResourceUsage_SourceManager_DataStructures")
      case CXTUResourceUsage_Preprocessor_HeaderSearch =>
        Some("CXTUResourceUsage_Preprocessor_HeaderSearch")
      case CXTUResourceUsage_MEMORY_IN_BYTES_BEGIN =>
        Some("CXTUResourceUsage_MEMORY_IN_BYTES_BEGIN")
      case CXTUResourceUsage_MEMORY_IN_BYTES_END =>
        Some("CXTUResourceUsage_MEMORY_IN_BYTES_END")
  ...
  inline def getName(inline value: CXTemplateArgumentKind): Option[String] =
    inline value match
      ...
      case CXTemplateArgumentKind_Declaration =>
        Some("CXTemplateArgumentKind_Declaration")
      case CXTemplateArgumentKind_NullPtr =>
        Some("CXTemplateArgumentKind_NullPtr")
      case CXTemplateArgumentKind_Integral =>
        Some("CXTemplateArgumentKind_Integral")
      case CXTemplateArgumentKind_Template =>
        Some("CXTemplateArgumentKind_Template")
      case CXTemplateArgumentKind_TemplateExpansion =>
        Some("CXTemplateArgumentKind_TemplateExpansion")
      case CXTemplateArgumentKind_Expression =>
        Some("CXTemplateArgumentKind_Expression")
      case CXTemplateArgumentKind_Pack => Some("CXTemplateArgumentKind_Pack")
      case CXTemplateArgumentKind_Invalid =>
        Some("CXTemplateArgumentKind_Invalid")
      case _ => None
...
object CXTranslationUnit_Flags extends CEnumU[CXTranslationUnit_Flags]:
  ...
  inline def getName(inline value: CXTranslationUnit_Flags): Option[String] =
    inline value match
      ...
      case CXTranslationUnit_DetailedPreprocessingRecord =>
        Some("CXTranslationUnit_DetailedPreprocessingRecord")
      case CXTranslationUnit_Incomplete => Some("CXTranslationUnit_Incomplete")
      case CXTranslationUnit_PrecompiledPreamble =>
        Some("CXTranslationUnit_PrecompiledPreamble")
      case CXTranslationUnit_CacheCompletionResults =>
        Some("CXTranslationUnit_CacheCompletionResults")
      case CXTranslationUnit_ForSerialization =>
        Some("CXTranslationUnit_ForSerialization")
      case CXTranslationUnit_CXXChainedPCH =>
        Some("CXTranslationUnit_CXXChainedPCH")
      case CXTranslationUnit_SkipFunctionBodies =>
        Some("CXTranslationUnit_SkipFunctionBodies")
      case CXTranslationUnit_IncludeBriefCommentsInCodeCompletion =>
        Some("CXTranslationUnit_IncludeBriefCommentsInCodeCompletion")
      case CXTranslationUnit_CreatePreambleOnFirstParse =>
        Some("CXTranslationUnit_CreatePreambleOnFirstParse")
      case CXTranslationUnit_KeepGoing => Some("CXTranslationUnit_KeepGoing")
      case CXTranslationUnit_SingleFileParse =>
        Some("CXTranslationUnit_SingleFileParse")
      case CXTranslationUnit_LimitSkipFunctionBodiesToPreamble =>
        Some("CXTranslationUnit_LimitSkipFunctionBodiesToPreamble")
      case CXTranslationUnit_IncludeAttributedTypes =>
        Some("CXTranslationUnit_IncludeAttributedTypes")
      case CXTranslationUnit_VisitImplicitAttributes =>
        Some("CXTranslationUnit_VisitImplicitAttributes")
      case CXTranslationUnit_IgnoreNonErrorsFromIncludedFiles =>
        Some("CXTranslationUnit_IgnoreNonErrorsFromIncludedFiles")
      case CXTranslationUnit_RetainExcludedConditionalBlocks =>
        Some("CXTranslationUnit_RetainExcludedConditionalBlocks")
      case _ => None
  ...
  inline def getName(inline value: CXTypeKind): Option[String] =
    inline value match
      ...
      case CXType_OCLImage2dArrayDepthRO =>
        Some("CXType_OCLImage2dArrayDepthRO")
      ...
      case CXType_OCLImage2dArrayMSAADepthRO =>
        Some("CXType_OCLImage2dArrayMSAADepthRO")
      ...
      case CXType_OCLImage2dArrayDepthWO =>
        Some("CXType_OCLImage2dArrayDepthWO")
      ...
      case CXType_OCLImage2dArrayMSAADepthWO =>
        Some("CXType_OCLImage2dArrayMSAADepthWO")
      ...
      case CXType_OCLImage2dArrayDepthRW =>
        Some("CXType_OCLImage2dArrayDepthRW")
      ...
      case CXType_OCLImage2dArrayMSAADepthRW =>
        Some("CXType_OCLImage2dArrayMSAADepthRW")
      ...
      case CXType_OCLIntelSubgroupAVCMcePayload =>
        Some("CXType_OCLIntelSubgroupAVCMcePayload")
      case CXType_OCLIntelSubgroupAVCImePayload =>
        Some("CXType_OCLIntelSubgroupAVCImePayload")
      case CXType_OCLIntelSubgroupAVCRefPayload =>
        Some("CXType_OCLIntelSubgroupAVCRefPayload")
      case CXType_OCLIntelSubgroupAVCSicPayload =>
        Some("CXType_OCLIntelSubgroupAVCSicPayload")
      case CXType_OCLIntelSubgroupAVCMceResult =>
        Some("CXType_OCLIntelSubgroupAVCMceResult")
      case CXType_OCLIntelSubgroupAVCImeResult =>
        Some("CXType_OCLIntelSubgroupAVCImeResult")
      case CXType_OCLIntelSubgroupAVCRefResult =>
        Some("CXType_OCLIntelSubgroupAVCRefResult")
      case CXType_OCLIntelSubgroupAVCSicResult =>
        Some("CXType_OCLIntelSubgroupAVCSicResult")
      case CXType_OCLIntelSubgroupAVCImeResultSingleReferenceStreamout =>
        Some("CXType_OCLIntelSubgroupAVCImeResultSingleReferenceStreamout")
      case CXType_OCLIntelSubgroupAVCImeResultDualReferenceStreamout =>
        Some("CXType_OCLIntelSubgroupAVCImeResultDualReferenceStreamout")
      case CXType_OCLIntelSubgroupAVCImeSingleReferenceStreamin =>
        Some("CXType_OCLIntelSubgroupAVCImeSingleReferenceStreamin")
      case CXType_OCLIntelSubgroupAVCImeDualReferenceStreamin =>
        Some("CXType_OCLIntelSubgroupAVCImeDualReferenceStreamin")
      case CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout =>
        Some("CXType_OCLIntelSubgroupAVCImeResultSingleRefStreamout")
      case CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout =>
        Some("CXType_OCLIntelSubgroupAVCImeResultDualRefStreamout")
  ...
  inline def getName(inline value: CXTypeLayoutError): Option[String] =
    inline value match
      ...
      case CXTypeLayoutError_NotConstantSize =>
        Some("CXTypeLayoutError_NotConstantSize")
      case CXTypeLayoutError_InvalidFieldName =>
        Some("CXTypeLayoutError_InvalidFieldName")
