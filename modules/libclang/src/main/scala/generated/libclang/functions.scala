...
@extern private[libclang] def __sn_wrap_libclang_clang_CXCursorSet_contains(
    cset: CXCursorSet,
    cursor: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXCursorSet_insert(
    cset: CXCursorSet,
    cursor: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXConstructor_isConvertingConstructor(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXConstructor_isCopyConstructor(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXConstructor_isDefaultConstructor(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXConstructor_isMoveConstructor(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXField_isMutable(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isConst(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isCopyAssignmentOperator(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isDefaulted(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isDeleted(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isExplicit(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isMoveAssignmentOperator(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isPureVirtual(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isStatic(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXMethod_isVirtual(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_CXXRecord_isAbstract(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_Evaluate(
    C: Ptr[CXCursor]
): CXEvalResult = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getArgument(
    C: Ptr[CXCursor],
    i: CUnsignedInt,
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getBriefCommentText(
    C: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getCXXManglings(
    _0: Ptr[CXCursor]
): Ptr[CXStringSet] = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getCommentRange(
    C: Ptr[CXCursor],
    __return: Ptr[CXSourceRange]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getMangling(
    _0: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getModule(
    C: Ptr[CXCursor]
): CXModule = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getNumArguments(
    C: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getNumTemplateArguments(
    C: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getObjCDeclQualifiers(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getObjCManglings(
    _0: Ptr[CXCursor]
): Ptr[CXStringSet] = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getObjCPropertyAttributes(
    C: Ptr[CXCursor],
    reserved: CUnsignedInt
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getObjCPropertyGetterName(
    C: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getObjCPropertySetterName(
    C: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getObjCSelectorIndex(
    _0: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getOffsetOfField(
    C: Ptr[CXCursor]
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getRawCommentText(
    C: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getReceiverType(
    C: Ptr[CXCursor],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getSpellingNameRange(
    _0: Ptr[CXCursor],
...
@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getStorageClass(
    _0: Ptr[CXCursor]
): CX_StorageClass = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getTemplateArgumentKind(
    C: Ptr[CXCursor],
    I: CUnsignedInt
): CXTemplateArgumentKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getTemplateArgumentType(
    C: Ptr[CXCursor],
    I: CUnsignedInt,
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getTemplateArgumentUnsignedValue(
    C: Ptr[CXCursor],
    I: CUnsignedInt
): CUnsignedLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getTemplateArgumentValue(
    C: Ptr[CXCursor],
    I: CUnsignedInt
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getTranslationUnit(
    _0: Ptr[CXCursor]
): CXTranslationUnit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_getVarDeclInitializer(
    cursor: Ptr[CXCursor],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_hasAttrs(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_hasVarDeclExternalStorage(
    cursor: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_hasVarDeclGlobalStorage(
    cursor: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isAnonymous(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isAnonymousRecordDecl(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isBitField(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isDynamicCall(
    C: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isExternalSymbol(
    C: Ptr[CXCursor],
...
@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isFunctionInlined(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isInlineNamespace(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isMacroBuiltin(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isMacroFunctionLike(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isNull(
    cursor: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isObjCOptional(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Cursor_isVariadic(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_EnumDecl_isScoped(
    C: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_File_tryGetRealPathName(
    file: CXFile,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Location_isFromMainFile(
    location: Ptr[CXSourceLocation]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Location_isInSystemHeader(
    location: Ptr[CXSourceLocation]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Module_getFullName(
    Module: CXModule,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Module_getName(
    Module: CXModule,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Range_isNull(
    range: Ptr[CXSourceRange]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_TargetInfo_getTriple(
    Info: CXTargetInfo,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getAlignOf(
    T: Ptr[CXType]
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getCXXRefQualifier(
    T: Ptr[CXType]
): CXRefQualifierKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getClassType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getModifiedType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getNamedType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getNullability(
    T: Ptr[CXType]
): CXTypeNullabilityKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getNumObjCProtocolRefs(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getNumObjCTypeArgs(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getNumTemplateArguments(
    T: Ptr[CXType]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getObjCEncoding(
    `type`: Ptr[CXType],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getObjCObjectBaseType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getObjCProtocolDecl(
    T: Ptr[CXType],
    i: CUnsignedInt,
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getObjCTypeArg(
    T: Ptr[CXType],
    i: CUnsignedInt,
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getOffsetOf(
    T: Ptr[CXType],
    S: CString
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getSizeOf(
    T: Ptr[CXType]
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getTemplateArgumentAsType(
    T: Ptr[CXType],
    i: CUnsignedInt,
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_getValueType(
    CT: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_isTransparentTagTypedef(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_Type_visitFields(
    T: Ptr[CXType],
    visitor: CXFieldVisitor,
    client_data: CXClientData
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_codeCompleteGetContainerUSR(
    Results: Ptr[CXCodeCompleteResults],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_codeCompleteGetObjCSelector(
    Results: Ptr[CXCodeCompleteResults],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_constructUSR_ObjCCategory(
    class_name: CString,
    category_name: CString,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_constructUSR_ObjCClass(
    class_name: CString,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_constructUSR_ObjCIvar(
    name: CString,
    classUSR: Ptr[CXString],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_constructUSR_ObjCMethod(
    name: CString,
...
@extern private[libclang] def __sn_wrap_libclang_clang_constructUSR_ObjCProperty(
    property: CString,
    classUSR: Ptr[CXString],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_constructUSR_ObjCProtocol(
    protocol_name: CString,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_disposeCXTUResourceUsage(
    usage: Ptr[CXTUResourceUsage]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_disposeString(
    string: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_equalCursors(
    _0: Ptr[CXCursor],
    _1: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_equalLocations(
    loc1: Ptr[CXSourceLocation],
    loc2: Ptr[CXSourceLocation]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_equalRanges(
    range1: Ptr[CXSourceRange],
    range2: Ptr[CXSourceRange]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_equalTypes(
    A: Ptr[CXType],
    B: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_findIncludesInFile(
    TU: CXTranslationUnit,
    file: CXFile,
    visitor: Ptr[CXCursorAndRangeVisitor]
): CXResult = extern

@extern private[libclang] def __sn_wrap_libclang_clang_findReferencesInFile(
    cursor: Ptr[CXCursor],
    file: CXFile,
    visitor: Ptr[CXCursorAndRangeVisitor]
): CXResult = extern

@extern private[libclang] def __sn_wrap_libclang_clang_findReferencesInFileWithBlock(
    _0: Ptr[CXCursor],
    _1: CXFile,
    _2: CXCursorAndRangeVisitorBlock
): CXResult = extern

@extern private[libclang] def __sn_wrap_libclang_clang_formatDiagnostic(
    Diagnostic: CXDiagnostic,
    Options: CUnsignedInt,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getAddressSpace(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getArgType(
    T: Ptr[CXType],
    i: CUnsignedInt,
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getArrayElementType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getArraySize(
    T: Ptr[CXType]
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getBinaryOperatorKindSpelling(
    kind: CXBinaryOperatorKind,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCString(
    string: Ptr[CXString]
): CString = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCXTUResourceUsage(
    TU: CXTranslationUnit,
    __return: Ptr[CXTUResourceUsage]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCXXAccessSpecifier(
    _0: Ptr[CXCursor]
): CX_CXXAccessSpecifier = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCanonicalCursor(
    _0: Ptr[CXCursor],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCanonicalType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getClangVersion(
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCompletionAnnotation(
    completion_string: CXCompletionString,
    annotation_number: CUnsignedInt,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCompletionBriefComment(
    completion_string: CXCompletionString,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCompletionChunkText(
    completion_string: CXCompletionString,
    chunk_number: CUnsignedInt,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCompletionFixIt(
    results: Ptr[CXCodeCompleteResults],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getCompletionParent(
    completion_string: CXCompletionString,
    kind: Ptr[CXCursorKind],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursor(
    _0: CXTranslationUnit,
    _1: Ptr[CXSourceLocation],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorAvailability(
    cursor: Ptr[CXCursor]
): CXAvailabilityKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorBinaryOperatorKind(
    cursor: Ptr[CXCursor]
): CXBinaryOperatorKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorCompletionString(
    cursor: Ptr[CXCursor]
): CXCompletionString = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorDefinition(
    _0: Ptr[CXCursor],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorDisplayName(
    _0: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorExceptionSpecificationType(
    C: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorExtent(
    _0: Ptr[CXCursor],
    __return: Ptr[CXSourceRange]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorKind(
    _0: Ptr[CXCursor]
): CXCursorKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorKindSpelling(
    Kind: CXCursorKind,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorLanguage(
    cursor: Ptr[CXCursor]
...
@extern private[libclang] def __sn_wrap_libclang_clang_getCursorLinkage(
    cursor: Ptr[CXCursor]
): CXLinkageKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorLocation(
    _0: Ptr[CXCursor],
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorPlatformAvailability(
    cursor: Ptr[CXCursor],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getCursorPrettyPrinted(
    Cursor: Ptr[CXCursor],
    Policy: CXPrintingPolicy,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorPrintingPolicy(
    _0: Ptr[CXCursor]
): CXPrintingPolicy = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorReferenceNameRange(
    C: Ptr[CXCursor],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getCursorReferenced(
    _0: Ptr[CXCursor],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorResultType(
    C: Ptr[CXCursor],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorSemanticParent(
    cursor: Ptr[CXCursor],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorSpelling(
    _0: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorTLSKind(
    cursor: Ptr[CXCursor]
): CXTLSKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorType(
    C: Ptr[CXCursor],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorUSR(
    _0: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorUnaryOperatorKind(
    cursor: Ptr[CXCursor]
): CXUnaryOperatorKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getCursorVisibility(
    cursor: Ptr[CXCursor]
): CXVisibilityKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDeclObjCTypeEncoding(
    C: Ptr[CXCursor],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDefinitionSpellingAndExtent(
    _0: Ptr[CXCursor],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticCategoryName(
    Category: CUnsignedInt,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticCategoryText(
    _0: CXDiagnostic,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticFixIt(
    Diagnostic: CXDiagnostic,
    FixIt: CUnsignedInt,
...
@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticLocation(
    _0: CXDiagnostic,
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticOption(
    Diag: CXDiagnostic,
    Disable: Ptr[CXString],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticRange(
    Diagnostic: CXDiagnostic,
    Range: CUnsignedInt,
    __return: Ptr[CXSourceRange]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getDiagnosticSpelling(
    _0: CXDiagnostic,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getElementType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getEnumConstantDeclUnsignedValue(
    C: Ptr[CXCursor]
): CUnsignedLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getEnumConstantDeclValue(
    C: Ptr[CXCursor]
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getEnumDeclIntegerType(
    C: Ptr[CXCursor],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getExceptionSpecificationType(
    T: Ptr[CXType]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getExpansionLocation(
    location: Ptr[CXSourceLocation],
    file: Ptr[CXFile],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getFieldDeclBitWidth(
    C: Ptr[CXCursor]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getFileLocation(
    location: Ptr[CXSourceLocation],
    file: Ptr[CXFile],
    line: Ptr[CUnsignedInt],
    column: Ptr[CUnsignedInt],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getFileName(
    SFile: CXFile,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getFunctionTypeCallingConv(
    T: Ptr[CXType]
): CXCallingConv = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getIBOutletCollectionType(
    _0: Ptr[CXCursor],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getIncludedFile(
    cursor: Ptr[CXCursor]
): CXFile = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getInstantiationLocation(
    location: Ptr[CXSourceLocation],
    file: Ptr[CXFile],
    line: Ptr[CUnsignedInt],
    column: Ptr[CUnsignedInt],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getLocation(
    tu: CXTranslationUnit,
    file: CXFile,
    line: CUnsignedInt,
    column: CUnsignedInt,
...
@extern private[libclang] def __sn_wrap_libclang_clang_getLocationForOffset(
    tu: CXTranslationUnit,
    file: CXFile,
    offset: CUnsignedInt,
    __return: Ptr[CXSourceLocation]
...
@extern private[libclang] def __sn_wrap_libclang_clang_getNonReferenceType(
    CT: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getNullCursor(
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getNullLocation(
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getNullRange(
    __return: Ptr[CXSourceRange]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getNumArgTypes(
    T: Ptr[CXType]
): CInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getNumElements(
    T: Ptr[CXType]
): CLongLong = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getNumOverloadedDecls(
    cursor: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getOverloadedDecl(
    cursor: Ptr[CXCursor],
    index: CUnsignedInt,
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getOverriddenCursors(
    cursor: Ptr[CXCursor],
    overridden: Ptr[Ptr[CXCursor]],
    num_overridden: Ptr[CUnsignedInt]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getPointeeType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getPresumedLocation(
    location: Ptr[CXSourceLocation],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getRange(
    begin: Ptr[CXSourceLocation],
    end: Ptr[CXSourceLocation],
    __return: Ptr[CXSourceRange]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getRangeEnd(
    range: Ptr[CXSourceRange],
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getRangeStart(
    range: Ptr[CXSourceRange],
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getResultType(
    T: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getSpecializedCursorTemplate(
    C: Ptr[CXCursor],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getSpellingLocation(
    location: Ptr[CXSourceLocation],
    file: Ptr[CXFile],
    line: Ptr[CUnsignedInt],
    column: Ptr[CUnsignedInt],
...
@extern private[libclang] def __sn_wrap_libclang_clang_getTemplateCursorKind(
    C: Ptr[CXCursor]
): CXCursorKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getToken(
    TU: CXTranslationUnit,
    Location: Ptr[CXSourceLocation]
): Ptr[CXToken] = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTokenExtent(
    _0: CXTranslationUnit,
    _1: Ptr[CXToken],
    __return: Ptr[CXSourceRange]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTokenKind(
    _0: Ptr[CXToken]
): CXTokenKind = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTokenLocation(
    _0: CXTranslationUnit,
    _1: Ptr[CXToken],
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTokenSpelling(
    _0: CXTranslationUnit,
    _1: Ptr[CXToken],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTranslationUnitCursor(
    _0: CXTranslationUnit,
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTranslationUnitSpelling(
    CTUnit: CXTranslationUnit,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTypeDeclaration(
    T: Ptr[CXType],
    __return: Ptr[CXCursor]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTypeKindSpelling(
    K: CXTypeKind,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTypeSpelling(
    CT: Ptr[CXType],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTypedefDeclUnderlyingType(
    C: Ptr[CXCursor],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getTypedefName(
    CT: Ptr[CXType],
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getUnaryOperatorKindSpelling(
    kind: CXUnaryOperatorKind,
    __return: Ptr[CXString]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_getUnqualifiedType(
    CT: Ptr[CXType],
    __return: Ptr[CXType]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_hashCursor(
    _0: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_indexLoc_getCXSourceLocation(
    loc: Ptr[CXIdxLoc],
    __return: Ptr[CXSourceLocation]
): Unit = extern

@extern private[libclang] def __sn_wrap_libclang_clang_indexLoc_getFileLocation(
    loc: Ptr[CXIdxLoc],
...
@extern private[libclang] def __sn_wrap_libclang_clang_isConstQualifiedType(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isCursorDefinition(
    _0: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isFunctionTypeVariadic(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isInvalidDeclaration(
    _0: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isPODType(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isRestrictQualifiedType(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isVirtualBase(
    _0: Ptr[CXCursor]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_isVolatileQualifiedType(
    T: Ptr[CXType]
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_tokenize(
    TU: CXTranslationUnit,
    Range: Ptr[CXSourceRange],
...
@extern private[libclang] def __sn_wrap_libclang_clang_visitChildren(
    parent: Ptr[CXCursor],
    visitor: CXCursorVisitor,
    client_data: CXClientData
): CUnsignedInt = extern

@extern private[libclang] def __sn_wrap_libclang_clang_visitChildrenWithBlock(
    parent: Ptr[CXCursor],
...
/** Sets general options associated with a CXIndex.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_CXIndex_setGlobalOptions(
    _0: CXIndex,
    options: CUnsignedInt
): Unit = extern
...
/** Sets the invocation emission path option in a CXIndex.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_CXIndex_setInvocationEmissionPathOption(
    _0: CXIndex,
    Path: CString
): Unit = extern
...
/** Returns the evaluation result as an unsigned integer if the kind is Int and
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_EvalResult_getAsUnsigned(E: CXEvalResult): CUnsignedLongLong =
  extern
...
/** Returns a non-zero value if the kind is Int and the evaluation result
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_EvalResult_isUnsignedInt(E: CXEvalResult): CUnsignedInt =
  extern

/** Returns non-zero if the file1 and file2 point to the same file, or they are
  * both NULL.
  *
...
/** Create a CXModuleMapDescriptor object. Must be disposed with
  ...
  */
@extern def clang_ModuleMapDescriptor_create(
    options: CUnsignedInt
...
/** Dispose a CXModuleMapDescriptor object.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_ModuleMapDescriptor_dispose(_0: CXModuleMapDescriptor): Unit =
  extern
...
/** Sets the framework module name that the module.map describes.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_ModuleMapDescriptor_setFrameworkModuleName(
...
/** Sets the umbrella header name that the module.map describes.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_ModuleMapDescriptor_setUmbrellaHeader(
    _0: CXModuleMapDescriptor,
    name: CString
): CXErrorCode = extern
...
/** Write out the CXModuleMapDescriptor object to a char buffer.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_ModuleMapDescriptor_writeToBuffer(
    _0: CXModuleMapDescriptor,
    options: CUnsignedInt,
...
/** Returns the number of top level headers associated with this module.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_Module_getNumTopLevelHeaders(
    _0: CXTranslationUnit,
    Module: CXModule
): CUnsignedInt = extern
...
/** Returns the specified top level header associated with the module.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_Module_getTopLevelHeader(
    _0: CXTranslationUnit,
    Module: CXModule,
    Index: CUnsignedInt
): CXFile = extern
...
/** Release a printing policy.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_PrintingPolicy_dispose(Policy: CXPrintingPolicy): Unit =
  extern
...
/** Get a property value for the given printing policy.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_PrintingPolicy_getProperty(
    Policy: CXPrintingPolicy,
...
/** Set a property value for the given printing policy.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_PrintingPolicy_setProperty(
    Policy: CXPrintingPolicy,
    Property: CXPrintingPolicyProperty,
    Value: CUnsignedInt
): Unit = extern
...
/** Map an absolute virtual file path to an absolute real one. The virtual path
  * must be canonicalized (not contain "."/"..").
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_VirtualFileOverlay_addFileMapping(
...
/** Create a CXVirtualFileOverlay object. Must be disposed with
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_VirtualFileOverlay_create(
    options: CUnsignedInt
...
/** Dispose a CXVirtualFileOverlay object.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_VirtualFileOverlay_dispose(_0: CXVirtualFileOverlay): Unit =
  extern
...
/** Set the case sensitivity for the CXVirtualFileOverlay object. The
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_VirtualFileOverlay_setCaseSensitivity(
    _0: CXVirtualFileOverlay,
    caseSensitive: CInt
): CXErrorCode = extern
...
/** Write out the CXVirtualFileOverlay object to a char buffer.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/BuildSystem.h
  */
@extern def clang_VirtualFileOverlay_writeToBuffer(
    _0: CXVirtualFileOverlay,
    options: CUnsignedInt,
    out_buffer_ptr: Ptr[CString],
    out_buffer_size: Ptr[CUnsignedInt]
...
/** Annotate the given set of tokens by providing cursors for each token that
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_annotateTokens(
    TU: CXTranslationUnit,
    Tokens: Ptr[CXToken],
...
/** Perform code completion at a given location in a translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_codeCompleteAt(
    TU: CXTranslationUnit,
...
/** Returns the cursor kind for the container for the current code completion
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_codeCompleteGetContainerKind(
    Results: Ptr[CXCodeCompleteResults],
...
/** Determines what completions are appropriate for the context the given code
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_codeCompleteGetContexts(
    Results: Ptr[CXCodeCompleteResults]
): CUnsignedLongLong = extern
...
/** Retrieve a diagnostic associated with the given code completion.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_codeCompleteGetDiagnostic(
    Results: Ptr[CXCodeCompleteResults],
    Index: CUnsignedInt
): CXDiagnostic = extern
...
/** Determine the number of diagnostics produced prior to the location where
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_codeCompleteGetNumDiagnostics(
    Results: Ptr[CXCodeCompleteResults]
): CUnsignedInt = extern
...
/** Provides a shared context for creating translation units.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_createIndexWithOptions(
...
/** Same as clang_createTranslationUnit2, but returns the CXTranslationUnit
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_createTranslationUnit(
    CIdx: CXIndex,
...
/** Create a translation unit from an AST file ( -emit-ast).
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_createTranslationUnit2(
    CIdx: CXIndex,
    ast_filename: CString,
...
/** Return the CXTranslationUnit for a given source file and the provided
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_createTranslationUnitFromSourceFile(
    CIdx: CXIndex,
...
/** Returns the set of flags that is suitable for reparsing a translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_defaultReparseOptions(TU: CXTranslationUnit): CUnsignedInt =
  extern
...
/** Returns the set of flags that is suitable for saving a translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_defaultSaveOptions(TU: CXTranslationUnit): CUnsignedInt =
  extern
...
/** Free the memory associated with a CXPlatformAvailability structure.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_disposeCXPlatformAvailability(
    availability: Ptr[CXPlatformAvailability]
): Unit = extern
...
/** Free the given set of code-completion results.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_disposeCodeCompleteResults(
    Results: Ptr[CXCodeCompleteResults]
): Unit = extern
...
/** Free the set of overridden cursors returned by clang_getOverriddenCursors().
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_disposeOverriddenCursors(overridden: Ptr[CXCursor]): Unit =
  extern

/** Destroy the given CXSourceRangeList.
  *
  * [bindgen] header:
  * /opt/homebrew/opt/llvm@17/include/clang-c/CXSourceLocation.h
  */
@extern def clang_disposeSourceRangeList(ranges: Ptr[CXSourceRangeList]): Unit =
  extern
...
/** Free the given set of tokens.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_disposeTokens(
    TU: CXTranslationUnit,
    Tokens: Ptr[CXToken],
    NumTokens: CUnsignedInt
): Unit = extern
...
/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_executeOnThread(
...
/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_findIncludesInFileWithBlock(
    _0: CXTranslationUnit,
    _1: CXFile,
    _2: CXCursorAndRangeVisitorBlock
): CXResult = extern
...
/** Retrieve all ranges from all files that were skipped by the preprocessor.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getAllSkippedRanges(
    tu: CXTranslationUnit
...
/** Determine the availability of the entity that this code-completion string
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getCompletionAvailability(
    completion_string: CXCompletionString
): CXAvailabilityKind = extern
...
/** Retrieve the completion string associated with a particular chunk within a
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getCompletionChunkCompletionString(
    completion_string: CXCompletionString,
    chunk_number: CUnsignedInt
): CXCompletionString = extern
...
/** Determine the kind of a particular chunk within a completion string.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getCompletionChunkKind(
    completion_string: CXCompletionString,
    chunk_number: CUnsignedInt
...
/** Retrieve the number of annotations associated with the given completion
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getCompletionNumAnnotations(
    completion_string: CXCompletionString
): CUnsignedInt = extern
...
/** Retrieve the number of fix-its for the given completion index.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getCompletionNumFixIts(
    results: Ptr[CXCodeCompleteResults],
    completion_index: CUnsignedInt
): CUnsignedInt = extern
...
/** Determine the priority of this code completion.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getCompletionPriority(
    completion_string: CXCompletionString
): CUnsignedInt = extern
...
/** Retrieve a diagnostic associated with the given translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getDiagnostic(
...
/** Retrieve a diagnostic associated with the given CXDiagnosticSet.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXDiagnostic.h
  */
@extern def clang_getDiagnosticInSet(
...
/** Determine the number of fix-it hints associated with the given diagnostic.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXDiagnostic.h
  */
@extern def clang_getDiagnosticNumFixIts(
    Diagnostic: CXDiagnostic
): CUnsignedInt = extern
...
/** Determine the number of source ranges associated with the given diagnostic.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXDiagnostic.h
  */
@extern def clang_getDiagnosticNumRanges(_0: CXDiagnostic): CUnsignedInt =
  extern
...
/** Retrieve the complete set of diagnostics associated with a translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getDiagnosticSetFromTU(
    Unit: CXTranslationUnit
...
/** Determine the severity of the given diagnostic.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXDiagnostic.h
  */
@extern def clang_getDiagnosticSeverity(
    _0: CXDiagnostic
): CXDiagnosticSeverity = extern

/** Retrieve a file handle within the given translation unit.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getFile(tu: CXTranslationUnit, file_name: CString): CXFile =
  extern
...
/** Retrieve the buffer associated with the given file.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getFileContents(
    tu: CXTranslationUnit,
    file: CXFile,
    size: Ptr[size_t]
): CString = extern
...
/** Retrieve the unique ID for the given file.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXFile.h
  */
@extern def clang_getFileUniqueID(
    file: CXFile,
    outID: Ptr[CXFileUniqueID]
): CInt = extern
...
/** Visit the set of preprocessor inclusions in a translation unit. The visitor
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getInclusions(
    tu: CXTranslationUnit,
...
/** Given a CXFile header file, return the module that contains it, if one
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getModuleForFile(
    _0: CXTranslationUnit,
    _1: CXFile
): CXModule = extern
...
/** Retrieve the number of chunks in the given code-completion string.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getNumCompletionChunks(
    completion_string: CXCompletionString
): CUnsignedInt = extern
...
/** Determine the number of diagnostics produced for the given translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getNumDiagnostics(Unit: CXTranslationUnit): CUnsignedInt =
  extern
...
/** Determine the number of diagnostics in a CXDiagnosticSet.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXDiagnostic.h
  */
@extern def clang_getNumDiagnosticsInSet(Diags: CXDiagnosticSet): CUnsignedInt =
  extern
...
/** Retrieve a remapping.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getRemappingsFromFileList(
...
/** Retrieve all ranges that were skipped by the preprocessor.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getSkippedRanges(
    tu: CXTranslationUnit,
    file: CXFile
): Ptr[CXSourceRangeList] = extern

/** Returns the human-readable null-terminated C string that represents the name
  * of the memory category. This string should never be freed.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getTUResourceUsageName(kind: CXTUResourceUsageKind): CString =
  extern
...
/** Get target information for this translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_getTranslationUnitTargetInfo(
    CTUnit: CXTranslationUnit
): CXTargetInfo = extern
...
/** Index the given source file and the translation unit corresponding to that
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_indexSourceFile(
    _0: CXIndexAction,
    client_data: CXClientData,
...
/** Same as clang_indexSourceFile but requires a full command line for
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_indexSourceFileFullArgv(
    _0: CXIndexAction,
    client_data: CXClientData,
    index_callbacks: Ptr[IndexerCallbacks],
    index_callbacks_size: CUnsignedInt,
...
/** Index the given translation unit via callbacks implemented through
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_indexTranslationUnit(
    _0: CXIndexAction,
    client_data: CXClientData,
    index_callbacks: Ptr[IndexerCallbacks],
    index_callbacks_size: CUnsignedInt,
...
/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getCXXClassDeclInfo(
...
/** For retrieving a custom CXIdxClientContainer attached to a container.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getClientContainer(
...
/** For retrieving a custom CXIdxClientEntity attached to an entity.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getClientEntity(
    _0: Ptr[CXIdxEntityInfo]
): CXIdxClientEntity = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getIBOutletCollectionAttrInfo(
    _0: Ptr[CXIdxAttrInfo]
): Ptr[CXIdxIBOutletCollectionAttrInfo] = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getObjCCategoryDeclInfo(
    _0: Ptr[CXIdxDeclInfo]
): Ptr[CXIdxObjCCategoryDeclInfo] = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getObjCContainerDeclInfo(
    _0: Ptr[CXIdxDeclInfo]
): Ptr[CXIdxObjCContainerDeclInfo] = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getObjCInterfaceDeclInfo(
    _0: Ptr[CXIdxDeclInfo]
): Ptr[CXIdxObjCInterfaceDeclInfo] = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getObjCPropertyDeclInfo(
    _0: Ptr[CXIdxDeclInfo]
): Ptr[CXIdxObjCPropertyDeclInfo] = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_getObjCProtocolRefListInfo(
    _0: Ptr[CXIdxDeclInfo]
): Ptr[CXIdxObjCProtocolRefListInfo] = extern

/** [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_isEntityObjCContainerKind(_0: CXIdxEntityKind): CInt =
  extern
...
/** For setting a custom CXIdxClientContainer attached to a container.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_setClientContainer(
    _0: Ptr[CXIdxContainerInfo],
...
/** For setting a custom CXIdxClientEntity attached to an entity.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_index_setClientEntity(
    _0: Ptr[CXIdxEntityInfo],
...
/** Determine whether the given header is guarded against multiple inclusions,
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_isFileMultipleIncludeGuarded(
    tu: CXTranslationUnit,
    file: CXFile
): CUnsignedInt = extern
...
/** * Determine whether the given cursor represents a currently unexposed piece
  * of the AST (e.g., CXCursor_UnexposedStmt).
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
/** Deserialize a set of diagnostics from a Clang diagnostics bitcode file.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/CXDiagnostic.h
  */
@extern def clang_loadDiagnostics(
    file: CString,
...
/** Same as clang_parseTranslationUnit2, but returns the CXTranslationUnit
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_parseTranslationUnit(
    CIdx: CXIndex,
    source_filename: CString,
    command_line_args: Ptr[CString],
    num_command_line_args: CInt,
...
/** Parse the given source file and the translation unit corresponding to that
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_parseTranslationUnit2(
    CIdx: CXIndex,
    source_filename: CString,
    command_line_args: Ptr[CString],
    num_command_line_args: CInt,
...
/** Same as clang_parseTranslationUnit2 but requires a full command line for
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_parseTranslationUnit2FullArgv(
    CIdx: CXIndex,
    source_filename: CString,
    command_line_args: Ptr[CString],
    num_command_line_args: CInt,
...
/** Get the original and the associated filename from the remapping.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_remap_getFilenames(
    _0: CXRemapping,
    index: CUnsignedInt,
...
/** Reparse the source files that produced this translation unit.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_reparseTranslationUnit(
    TU: CXTranslationUnit,
    num_unsaved_files: CUnsignedInt,
    unsaved_files: Ptr[CXUnsavedFile],
    options: CUnsignedInt
...
/** Saves a translation unit into a serialized representation of that
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_saveTranslationUnit(
    TU: CXTranslationUnit,
    FileName: CString,
    options: CUnsignedInt
): CInt = extern
...
/** Sort the code-completion results in case-insensitive alphabetical order.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_sortCodeCompletionResults(
...
/** Suspend a translation unit in order to free memory associated with it.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
@extern def clang_suspendTranslationUnit(_0: CXTranslationUnit): CUnsignedInt =
  extern
...
end clang_CXCursorSet_contains
...
end clang_CXXConstructor_isConvertingConstructor
...
end clang_CXXConstructor_isCopyConstructor
...
end clang_CXXConstructor_isDefaultConstructor
...
end clang_CXXConstructor_isMoveConstructor
...
/** Determine if a C++ member function is a copy-assignment operator, returning
  * 1 if such is the case and 0 otherwise.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_CXXMethod_isCopyAssignmentOperator(C: CXCursor)(using
    Zone
): CUnsignedInt =
  val __ptr_0: Ptr[CXCursor] = alloc[CXCursor](1)
  !(__ptr_0 + 0) = C
  __sn_wrap_libclang_clang_CXXMethod_isCopyAssignmentOperator((__ptr_0 + 0))
end clang_CXXMethod_isCopyAssignmentOperator
...
/** Determine if a C++ member function is a move-assignment operator, returning
  * 1 if such is the case and 0 otherwise.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
/** Determine if a C++ member function is a move-assignment operator, returning
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_CXXMethod_isMoveAssignmentOperator(C: CXCursor)(using
    Zone
): CUnsignedInt =
  val __ptr_0: Ptr[CXCursor] = alloc[CXCursor](1)
  !(__ptr_0 + 0) = C
  __sn_wrap_libclang_clang_CXXMethod_isMoveAssignmentOperator((__ptr_0 + 0))
end clang_CXXMethod_isMoveAssignmentOperator
...
/** Determine if a C++ record is abstract, i.e. whether a class or struct has a
...
/** If cursor is a statement declaration tries to evaluate the statement and if
  * its variable, tries to evaluate its initializer, into its corresponding
  * type. If it's an expression, tries to evaluate the expression.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
def clang_Cursor_getCommentRange(C: CXCursor)(using Zone): CXSourceRange =
  ...
  !(__ptr_0 + 0)
end clang_Cursor_getCommentRange
...
/** Given a cursor pointing to an Objective-C message or property reference, or
  * C++ method call, returns the CXType of the receiver.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_Cursor_getReceiverType(C: CXCursor)(using Zone): CXType =
  ...
  !(__ptr_0 + 0)
end clang_Cursor_getReceiverType
...
end clang_Cursor_getTemplateArgumentKind

/** Retrieve a CXType representing the type of a TemplateArgument of a function
  * decl representing a template specialization.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
end clang_Cursor_getTemplateArgumentValue
...
end clang_Cursor_getTranslationUnit
...
def clang_Cursor_getVarDeclInitializer(cursor: CXCursor)(using Zone): CXCursor =
  ...
  !(__ptr_0 + 1)
end clang_Cursor_getVarDeclInitializer
...
/** If cursor refers to a variable declaration that has external storage returns
  * \1. If cursor refers to a variable declaration that doesn't have external
...
/** If cursor refers to a variable declaration that has global storage returns
  * \1. If cursor refers to a variable declaration that doesn't have global
  * storage returns 0. Otherwise returns -1.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
end clang_Location_isFromMainFile
...
end clang_Location_isInSystemHeader
...
/** Returns the number of template arguments for given template specialization,
  * or -1 if type T is not a template specialization.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
def clang_Type_getObjCEncoding(`type`: CXType)(using Zone): CXString =
  ...
  !(__ptr_1 + 0)
end clang_Type_getObjCEncoding
...
def clang_Type_getObjCObjectBaseType(T: CXType)(using Zone): CXType =
  ...
  !(__ptr_0 + 1)
end clang_Type_getObjCObjectBaseType
...
def clang_codeCompleteGetContainerUSR(Results: Ptr[CXCodeCompleteResults])(using
  ...
  !(__ptr_0 + 0)
end clang_codeCompleteGetContainerUSR
...
def clang_codeCompleteGetObjCSelector(Results: Ptr[CXCodeCompleteResults])(using
  ...
  !(__ptr_0 + 0)
end clang_codeCompleteGetObjCSelector
...
end clang_findReferencesInFileWithBlock
...
/** Retrieve the spelling of a given CXBinaryOperatorKind.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_getBinaryOperatorKindSpelling(kind: CXBinaryOperatorKind)(using
    Zone
): CXString =
  val __ptr_0: Ptr[CXString] = alloc[CXString](1)
  __sn_wrap_libclang_clang_getBinaryOperatorKindSpelling(kind, (__ptr_0 + 0))
  !(__ptr_0 + 0)
end clang_getBinaryOperatorKindSpelling

/** Retrieve the spelling of a given CXBinaryOperatorKind.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_getBinaryOperatorKindSpelling(kind: CXBinaryOperatorKind)(
    __return: Ptr[CXString]
): Unit =
...
def clang_getCXTUResourceUsage(TU: CXTranslationUnit)(using
  ...
  !(__ptr_0 + 0)
end clang_getCXTUResourceUsage
...
end clang_getCXXAccessSpecifier
...
end clang_getCursorAvailability

/** Retrieve the binary operator kind of this cursor.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_getCursorBinaryOperatorKind(cursor: CXCursor)(using
    Zone
): CXBinaryOperatorKind =
  val __ptr_0: Ptr[CXCursor] = alloc[CXCursor](1)
  !(__ptr_0 + 0) = cursor
  __sn_wrap_libclang_clang_getCursorBinaryOperatorKind((__ptr_0 + 0))
end clang_getCursorBinaryOperatorKind
...
end clang_getCursorCompletionString
...
def clang_getCursorDisplayName(_0: CXCursor)(using Zone): CXString =
  ...
  !(__ptr_1 + 0)
end clang_getCursorDisplayName
...
/** Retrieve the unary operator kind of this cursor.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_getCursorUnaryOperatorKind(cursor: CXCursor)(using
    Zone
): CXUnaryOperatorKind =
  val __ptr_0: Ptr[CXCursor] = alloc[CXCursor](1)
  !(__ptr_0 + 0) = cursor
  __sn_wrap_libclang_clang_getCursorUnaryOperatorKind((__ptr_0 + 0))
end clang_getCursorUnaryOperatorKind
...
def clang_getDeclObjCTypeEncoding(C: CXCursor)(using Zone): CXString =
  ...
  !(__ptr_1 + 0)
end clang_getDeclObjCTypeEncoding
...
def clang_getDiagnosticCategoryName(Category: CUnsignedInt)(using
  ...
  !(__ptr_0 + 0)
end clang_getDiagnosticCategoryName
...
def clang_getDiagnosticLocation(_0: CXDiagnostic)(using
  ...
  !(__ptr_0 + 0)
end clang_getDiagnosticLocation
...
end clang_getEnumConstantDeclUnsignedValue
...
def clang_getEnumDeclIntegerType(C: CXCursor)(using Zone): CXType =
  ...
  !(__ptr_0 + 0)
end clang_getEnumDeclIntegerType
...
def clang_getLocationForOffset(
  ...
  !(__ptr_0 + 0)
end clang_getLocationForOffset
...
def clang_getSpecializedCursorTemplate(C: CXCursor)(using Zone): CXCursor =
  ...
  !(__ptr_0 + 1)
end clang_getSpecializedCursorTemplate
...
def clang_getTranslationUnitCursor(_0: CXTranslationUnit)(using
  ...
  !(__ptr_0 + 0)
end clang_getTranslationUnitCursor
...
def clang_getTranslationUnitSpelling(CTUnit: CXTranslationUnit)(using
  ...
  !(__ptr_0 + 0)
end clang_getTranslationUnitSpelling
...
/** Retrieve the spelling of a given CXUnaryOperatorKind.
  ...
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_getUnaryOperatorKindSpelling(kind: CXUnaryOperatorKind)(using
    Zone
): CXString =
  val __ptr_0: Ptr[CXString] = alloc[CXString](1)
  __sn_wrap_libclang_clang_getUnaryOperatorKindSpelling(kind, (__ptr_0 + 0))
  !(__ptr_0 + 0)
end clang_getUnaryOperatorKindSpelling

/** Retrieve the spelling of a given CXUnaryOperatorKind.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
def clang_getUnaryOperatorKindSpelling(kind: CXUnaryOperatorKind)(
    __return: Ptr[CXString]
): Unit =
  __sn_wrap_libclang_clang_getUnaryOperatorKindSpelling(kind, __return)

/** Retrieve the unqualified variant of the given type, removing as little sugar
  * as possible.
  *
  * [bindgen] header: /opt/homebrew/opt/llvm@17/include/clang-c/Index.h
  */
...
end clang_visitChildrenWithBlock
